...
class MockGameState:
    ...
    def get_active_entity_manifest(self) -> Dict[str, Any]:
        ...
        if (self._manifest_cache and self._manifest_timestamp and 
            (current_time - self._manifest_timestamp).seconds < 60):
...
class NarrativeValidationMixin:
    ...
    def generate_narrative_with_validation(self, game_state: MockGameState, 
