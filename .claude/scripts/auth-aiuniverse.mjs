...
const child = spawn('node', [mainScript, '--project', 'ai-universe-b3551', ...args], {
  stdio: 'inherit',
  env: {
    ...process.env,
    VITE_AI_UNIVERSE_FIREBASE_PROJECT_ID: 'ai-universe-b3551',
    VITE_AI_UNIVERSE_FIREBASE_AUTH_DOMAIN: 'ai-universe-b3551.firebaseapp.com',
