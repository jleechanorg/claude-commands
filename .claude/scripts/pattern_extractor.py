...
class PatternExtractor:
    ...
    # Context indicators
    RUSH_INDICATORS = [
        "ship it", "just make it work", "quick fix", "urgent",
        "asap", "rush", "fast", "now", "today"
    ]
    
    QUALITY_INDICATORS = [
        "take your time", "careful", "critical", "production",
        "thorough", "comprehensive", "polish", "perfect"
    ]
    ...
    def _analyze_correction(self, correction: str) -> Optional[Pattern]:
        ...
        if any(term in correction.lower() for term in ['structure', 'organize', 'refactor']):
    ...
    def _detect_context(self, text: str) -> Optional[Pattern]:
