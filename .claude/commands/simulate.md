...
**Action Steps:**
1. Read the simulation prompt file: `genesis/jleechan_simulation_prompt.md` (from project root)
...
- The simulation prompt is at `genesis/jleechan_simulation_prompt.md` relative to project root
