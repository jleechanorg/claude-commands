...
# Use single-quoted literal patterns to avoid shell expansion; match any /Users/username/ paths
grep -rE '/Users/[^/]+/|/home/[^/]+/projects/' .claude/commands --include="*.md" --include="*.py" --include="*.sh" 2>/dev/null | head -5
echo "   ... ($(grep -rE '/Users/[^/]+/|/home/[^/]+/projects/' .claude/commands --include="*.md" --include="*.py" --include="*.sh" 2>/dev/null | wc -l) total matches)"
