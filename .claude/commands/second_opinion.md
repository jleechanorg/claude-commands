...
export FIREBASE_API_KEY="${AI_UNIVERSE_FIREBASE_API_KEY:?set in your env}"  # obtain from AI Universe project
...
if [ $? -ne 0 ]; then
  ...
  echo "   FIREBASE_API_KEY=YOUR_AI_UNIVERSE_FIREBASE_API_KEY \\"
