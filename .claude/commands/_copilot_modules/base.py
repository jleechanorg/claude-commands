...
class CopilotCommandBase(ABC):
    ...
    def _get_repo_info(self) -> str:
        ...
        try:
            ...
            try:
                ...
                pass
            # Default fallback - use DEFAULT_REPO or GITHUB_REPOSITORY env var
            return os.environ.get("DEFAULT_REPO") or os.environ.get("GITHUB_REPOSITORY", "")
    ...
    def run_ci_replica(self, script_path: str = "run_ci_replica.sh") -> Dict[str, Any]:
        ...
        try:
            ...
            home_dir = Path.home()
            project_name = os.environ.get("PROJECT_NAME", "your-project.com")
            script_locations = [
                script_path,
                f"./{script_path}",
                f"../../{script_path}",
