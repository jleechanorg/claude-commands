...
if [[ ! -d "/Users/jleechan/projects/worktree_ralph" ]]; then
    echo "❌ ERROR: Source repository not found at /Users/jleechan/projects/worktree_ralph"
    exit 1
fi
echo "✅ Source repository found"

# Verify credentials
if [[ ! -f "/Users/jleechan/projects/worktree_ralph/testing_http/testing_full/.env" ]]; then
...
if [[ ! -f "/Users/jleechan/projects/worktree_ralph/roadmap/mvp_site_typescript_migration_eng_design.md" ]]; then
...
# Verify test cases
TEST_CASE_COUNT=$(find /Users/jleechan/projects/worktree_ralph/testing_llm -name "*.md" 2>/dev/null | wc -l)
...
if [[ ! -d "/Users/jleechan/projects_other/ralph-orchestrator" ]]; then
    echo "❌ ERROR: Ralph not found at /Users/jleechan/projects_other/ralph-orchestrator"
    exit 1
fi
echo "✅ Ralph installation found"

# Verify Genesis installation
if [[ ! -f "/Users/jleechan/projects/worktree_ralph/genesis/genesis.py" ]]; then
    echo "❌ ERROR: Genesis not found at /Users/jleechan/projects/worktree_ralph/genesis/genesis.py"
    exit 1
fi
echo "✅ Genesis installation found"

# Verify benchmark goal files
if [[ ! -f "/Users/jleechan/projects/worktree_ralph/roadmap/genesis_typescript_migration_benchmark.md" ]]; then
    echo "❌ ERROR: Genesis benchmark goal file not found"
    exit 1
fi
if [[ ! -f "/Users/jleechan/projects/worktree_ralph/roadmap/ralph_typescript_migration_benchmark.md" ]]; then
...
if [[ -d "/Users/jleechan/projects_other/worldai_genesis2" ]]; then
    ...
    echo "   Run: rm -rf /Users/jleechan/projects_other/worldai_genesis2"
    exit 1
fi
if [[ -d "/Users/jleechan/projects_other/worldai_ralph2" ]]; then
    ...
    echo "   Run: rm -rf /Users/jleechan/projects_other/worldai_ralph2"
    exit 1
fi
...
echo ""
echo "📋 Configuration:"
echo "  Source: /Users/jleechan/projects/worktree_ralph/mvp_site/"
echo "  Genesis Target: /Users/jleechan/projects_other/worldai_genesis2"
echo "  Ralph Target: /Users/jleechan/projects_other/worldai_ralph2"
