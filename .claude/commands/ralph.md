...
**Ralph** = Standalone ralph-orchestrator fork at `/Users/jleechan/projects_other/ralph-orchestrator`
...
- Located at: `/Users/jleechan/projects/worktree_ralph/genesis/`
...
**Required**: `/Users/jleechan/projects_other/ralph-orchestrator`
...
- `ralph-repo-path`: (Optional) Path to Ralph repo (default: `/Users/jleechan/projects_other/ralph-orchestrator`)
...
1. **Verify Ralph Repository**
   ```bash
   # Default location
   RALPH_REPO="/Users/jleechan/projects_other/ralph-orchestrator"
...
/ralph /Users/jleechan/projects/orch_worldai_ralph/complete-production-deployment.md 30
...
python -m ralph_orchestrator \
    /Users/jleechan/projects/orch_worldai_ralph/complete-production-deployment.md \
    --agent codex \
    --max-iterations 30 \
    --verbose
```
