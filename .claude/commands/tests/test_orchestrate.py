...
frontend-agent: 1 windows (created Thu Jul 17 13:49:48 2025)"""
        ...
        mock_run.assert_any_call(['redis-cli', 'ping'], 
                                capture_output=True, text=True, timeout=5)
        mock_run.assert_any_call(['tmux', 'list-sessions'], 
                                capture_output=True, text=True, timeout=5)
    ...
    def test_agent_cleanup_stuck_detection(self, mock_run):
        ...
        mock_run.side_effect = [list_result, capture_result1, send_result, 
                               capture_result2, send_result]
    ...
    def test_agent_cleanup_active_detection(self, mock_run):
        ...
        capture_result = Mock()
        capture_result.returncode = 0
        capture_result.stdout = "Processing task: Implementing user authentication...\n" + \
                               "✅ Created auth module\n" + \
                               "🔄 Writing tests..."
...
frontend-agent: 1 windows (created Thu Jul 17 13:49:48 2025)"""
        ...
        with patch('builtins.open', create=True) as mock_open:
            mock_open.return_value.__enter__.return_value.readlines.return_value = ['task1\n', 'task2\n']
