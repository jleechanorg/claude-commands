...
def validate_task_scope(task_description):
    ...
    overly_broad_keywords = ['rewrite', 'entire', 'all', 'everything', 'complete overhaul']
    
    task_lower = task_description.lower()
    for keyword in overly_broad_keywords:
        if keyword in task_lower:
            return False, f"Task appears too broad. Consider breaking down into smaller tasks."
...
def main():
    ...
    subprocess.run(['git', 'commit', '-m', f'Start implementation: {task_description}\n\n🤖 Generated with [Claude Code](https://claude.ai/code)\n\nCo-Authored-By: Claude <noreply@anthropic.com>'], check=True)
