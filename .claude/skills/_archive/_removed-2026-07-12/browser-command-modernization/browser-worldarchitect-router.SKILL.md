---
name: browser
description: Unified browser automation for a Playwright/Superpowers-Chrome project (your-project.com-style repo layout) — auto-selects Playwright for visual/multi-step/multi-browser work and Superpowers Chrome for quick smoke/debug/persistent-session work. Slash command: /browser. Subcommands: smoke, campaign, visual, debug, e2e.
---
