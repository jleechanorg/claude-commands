...
description: "Use for production-code PRs (your_app/**, gates, ZFC). Requires full GitHub URL to governing roadmap/design doc and a `br` bead ID in the body."
---

# PR body — governing design doc and bead (prod / gates / ZFC)


For any PR that changes production code under `your_app/**`, CI gates, or ZFC/level-up behavior, the PR description **must** include:
