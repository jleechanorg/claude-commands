...
| **Project B** | `your-secondary-project-id` | Your secondary application auth | `node scripts/auth-cli.mjs token --project your-secondary-project-id` |
...
#### Project B (`your-secondary-project-id`)
- Your secondary application authentication
- Firebase auth for your additional app platform
- Direct secondary project API calls
