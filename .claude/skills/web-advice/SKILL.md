...
Models don't always format in the exact section headers. If the regex misses, look for the verdict line in the visible response (Gemini and Grok usually structure their output; ChatGPT may be more conversational).
...
**Convergence:** <2-of-3 agree, all 3 agree, 3-way split>
**Recommended action:** <APPROVE / approve with conditions / change requests>
**Open web sources cited:** <list URLs>
```

**Decision rule:** 2-of-3 agreement is sufficient. If all 3 diverge, surface the disagreement to the user and ask which axis (speed / safety / cost) matters most.
