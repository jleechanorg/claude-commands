...
> **SKEPTIC GATE REMOVED (2026-07-09).** The skeptic-cron/self-verify system was deleted from your-project.com (repo removal PR #8217; lingering workflow registrations disabled 2026-07-09). Ignore every Skeptic/Gate-7 instruction below — the merge bar is now 6-green: CI green + no conflicts + CR APPROVED + Bugbot clean + comments resolved + evidence (/er PASS at head). Do not post /skeptic; nothing answers it.
