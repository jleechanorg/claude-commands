...
description: Use when reviewing evidence artifacts or a PR claim against the evidence standards and issuing a verdict.
---
...
| **PARTIAL** | Claims are supported but one or more mandatory checks soft-warn (e.g., WARN in an optional verification_report.json, missing downloadable MP4). A PR at PARTIAL is not merge-ready. |
