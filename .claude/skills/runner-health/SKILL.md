...
context:
  ...
  - "The fleet has 16 Linux runners (org-runner-1..16) on jeff-ubuntu + 6 mac runners (org-runner-mac-1..6) on the local Mac. AO per-repo auxiliaries (worldai_claw, mctrl_test, jleechanclaw, ai_universe_living_blog) live on jeff-ubuntu and suffer RUNNER_TOKEN expiry (PR #702 fixes root cause)."
