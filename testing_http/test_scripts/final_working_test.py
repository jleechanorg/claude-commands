...
def run_working_test():
    ...
    try:
        ...
        log(f"Server running on port 8083 with TESTING=True", "SUCCESS")
    except:
    ...
    if create_resp.status_code == 201:
        ...
        if combat_resp.status_code == 500:
            ...
            if "AttributeError" in error_str and "'list' object has no attribute 'items'" in error_str:
                log("\n" + "="*70, "INFO")
                ...
                if "traceback" in error_data:
                    ...
                    for line in error_data["traceback"].split("\n"):
                        if "AttributeError" in line or ".items()" in line or "game_state.py" in line:
