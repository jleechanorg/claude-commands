...
def test_with_working_auth():
    ...
    if create_resp.status_code == 201:
        ...
        if story_resp.status_code == 200:
            ...
            log(f"Story generated successfully: {len(story_text)} characters", "SUCCESS")
            ...
            if combat_resp.status_code == 500:
                ...
                if "AttributeError" in error_text and "'list' object has no attribute 'items'" in error_text:
                    ...
                    log("Different 500 error (not the reported AttributeError)", "WARNING")
                ...
                log(f"Combat story generated: {len(combat_story)} characters", "SUCCESS")
            else:
