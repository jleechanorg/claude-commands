...
def test_custom_campaign_no_dragon_knight_defaults():
    ...
    print("📤 Creating custom campaign that should NOT show Dragon Knight defaults")
    ...
    if response.status_code == 201:
        ...
        if get_response.status_code == 200:
            ...
            try:
                ...
                print(
                    "✓ Bug fix validated: Custom campaigns properly isolated from Dragon Knight content"
                )
                ...
                raise Exception(
                    "Dragon Knight defaults found in custom campaign - bug not fixed"
                )
...
def test_custom_campaign_with_default_world():
    ...
    print("📤 Creating custom campaign with default world setting")
    print(f"   Custom options: {campaign_data['custom_options']}")
    print("   This should NOT trigger Dragon Knight defaults")
    ...
    if response.status_code == 201:
        ...
        if get_response.status_code == 200:
            ...
            try:
                ...
                print(
                    "✓ No Dragon Knight contamination in custom campaign with default world"
                )
                ...
                print(
                    "⚠️  Custom campaign + default world is pulling Dragon Knight content!"
                )
                raise Exception(
                    "Default world bug not fixed - Dragon Knight content leaking"
                )
...
def test_dragon_knight_campaign_still_works():
    ...
    print("📤 Creating Dragon Knight campaign (should work normally)")
    print(f"   Type: {campaign_data['campaign_type']}")
