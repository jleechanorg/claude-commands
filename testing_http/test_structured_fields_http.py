        ...
        if get_response.status_code == 200:
            ...
            if 'narrative_history' in campaign_details:
                ...
                if narrative_history and len(narrative_history) > 0:
                    ...
                    expected_structured_fields = ['planning_block', 'god_mode_response', 'session_header']
                    found_fields = []
                    ...
                    if len(found_fields) >= 2:
                        ...
                        print(f"⚠️  Only found {len(found_fields)} structured fields: {found_fields}")
                    ...
                    if 'god_mode_response' in first_entry:
                        ...
                        if expected_character in god_mode_text:
                            print(f"✓ Character name '{expected_character}' found in story")
                        else:
                            print(f"⚠️  Character name '{expected_character}' not found in god_mode_response")
                    ...
                    print("⚠️  No narrative history entries found (may be normal for async generation)")
            
            print("✅ SUCCESS: Structured fields campaign creation via HTTP API working!")
            return campaign_id
...
def test_structured_fields_empty_character():
    ...
    print(f"📤 Creating campaign with empty character field")
