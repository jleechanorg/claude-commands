...
'''
        ...
        print("Success Generated install.sh script")
    ...
    def _generate_readme(self):
        ...
        # Replace dynamic placeholders with actual counts and version
        ...
        if '## Version History' not in readme_content:
            version_section = f'''
...
'''
            # Insert version section before the end marker or at the end
            ...
            # Update existing version history - add new version at top
            new_version_entry = f'''### {self.current_version} ({time.strftime('%Y-%m-%d')})
...
'''
            # Insert new version after "## Version History" header
            readme_content = readme_content.replace('## Version History\n', f'## Version History\n\n{new_version_entry}')
        
        # Add current export statistics if there's a placeholder section
        stats_section = f'''
...
'''
        ...
        # Insert stats before the installation section
        readme_content = readme_content.replace(
            '## 🔧 Installation & Setup',
            stats_section + '## 🔧 Installation & Setup'
        )
