...
class ClaudeCommandsExporter:
    ...
    def _export_hooks(self, staging_dir):
        """Export Claude Code hooks with proper permissions"""
        ...
        # Use rsync to preserve directory structure and permissions
        cmd = [
            'rsync', '-av',
            '--include=*/',
            '--include=*.sh',
...
'''
    ...
    def _copy_to_repository(self):
        """Copy exported content to repository"""
        print("📋 Copying exported content...")
        
        # Clear existing content  
        dirs_to_clear = ['commands', 'hooks', 'infrastructure-scripts', 'orchestration']
        ...
        # Note: README is generated based on actual export counts, not worldarch project state
