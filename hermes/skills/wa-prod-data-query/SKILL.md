...
ls ~/your-project.com/$PROJECT_ROOT/firestore_service.py  # WA firestore_service
```
...
import sys
sys.path.insert(0, "$HOME/.hermes_prod/skills/wa-prod-data-query/scripts")
