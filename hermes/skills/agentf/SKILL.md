...
```
Multiple projects configured. Specify one: agent-orchestrator, agf-api, agf-lambda, claude-commands, ai-universe-lite, cmux, dark-factory, heretic-lab, jleechanclaw, mcp-mail, mctrl-test, merge_train, openclaw-sso, ralph, smartclaw, worldai-claw, worldarchitect
```
