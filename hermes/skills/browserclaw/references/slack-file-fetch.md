...
| `~/.profile` | `SLACK_USER_TOKEN` | **canonical — [REDACTED_SLACK_TOKEN] user token, used for cross-workspace fallback per SOUL.md `## COMMIT: slack-cross-workspace-fallback-xoxp`** |
