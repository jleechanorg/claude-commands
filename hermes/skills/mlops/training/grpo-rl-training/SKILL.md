...
description: Expert guidance for GRPO/RL fine-tuning with TRL for reasoning and ta[REDACTED_OPENAI_KEY] model training
version: 1.0.0
...
4. **Reference examples** in `examples/` for ta[REDACTED_OPENAI_KEY] implementations
