...
- Repo: `jleechanorg/granola-exporter` (local: `/Users/$USER/Repos/granola-exporter`)
...
ls -la /Users/$USER/.hermes/scripts/granola-to-drive.py
# If missing → restore from /Users/$USER/Repos/granola-exporter/scripts/granola-to-drive.py
#   cp /Users/$USER/Repos/granola-exporter/scripts/granola-to-drive.py \
#      /Users/$USER/.hermes/scripts/granola-to-drive.py
...
d = json.load(open('/Users/$USER/.mcporter/credentials.json'))
...
python3 /Users/$USER/.hermes/scripts/granola-to-drive.py --preview

# Dry-run (same as --preview, kept for back-compat)
python3 /Users/$USER/.hermes/scripts/granola-to-drive.py --dry-run

# Force re-email everything (ignores state file)
python3 /Users/$USER/.hermes/scripts/granola-to-drive.py --force

# Override recipient for one-off test
GRANOLA_RECIPIENT_EMAIL=someone@example.com python3 /Users/$USER/.hermes/scripts/granola-to-drive.py --preview
```

## After editing the script

```bash
cd /Users/$USER/Repos/granola-exporter
...
cp scripts/granola-to-drive.py /Users/$USER/.hermes/scripts/granola-to-drive.py
launchctl bootout gui/$(id -u)/ai.hermes.schedule.granola-to-drive 2>&1 | head
launchctl bootstrap gui/$(id -u) /Users/$USER/Library/LaunchAgents/ai.hermes.schedule.granola-to-drive.plist
...
- `can't open file '/Users/$USER/.hermes/scripts/granola-to-drive.py'` — same as 126. Re-copy from repo.
...
```
1. `ls -la /Users/$USER/.hermes/scripts/granola-to-drive.py` — flag if missing
