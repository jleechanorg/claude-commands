...
Session-specific case study. Captures the actual numbers from a live disk-pressure triage so future agents have a concrete baseline.
...
- Silence flag: `--silence` writes `$HOME/.disk-usage-alert.silenced`
