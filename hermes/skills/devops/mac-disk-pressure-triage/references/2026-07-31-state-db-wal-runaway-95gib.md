...
Trap #5 added to `mac-di[REDACTED_OPENAI_KEY]` SKILL.md covering: symptom signature, root cause, diagnosis ladder (5 commands), safe recovery path (4 steps), forbidden footguns (4 items), and the WAL-vs-other-offender diagnostic signal.
