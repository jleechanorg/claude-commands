...
metadata:
  hermes:
    ...
    related_skills: [gh-actions-slow-runs, spend-alert-bridge, wa-cloud-run-deploy-failure-debug, mac-disk-pressure-triage]
---
...
- `~/.hermes/skills/mac-disk-pressure-triage/SKILL.md` - the disk-diagnosis sibling skill (different resource, same "first-use three concurrent lanes" pattern).
