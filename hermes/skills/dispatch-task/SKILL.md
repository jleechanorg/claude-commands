...
name: dispatch-task
version: 2.1.0
description: Dispatch a task via ao spawn/ao send with a GitHub Issue for tracking, and ack in Slack thread.
changelog:
...
```bash
AO=/Users/$USER/.nvm/versions/node/v22.22.0/bin/ao
