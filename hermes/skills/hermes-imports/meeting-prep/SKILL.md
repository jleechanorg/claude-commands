...
- `workspace` — absolute path to Hermes workspace (e.g. /home/user/.hermes/workspace)
- `chief_of_staff.name` and `chief_of_staff.slack_dm_channel` — for Slack DM delivery of briefs
...
Task: "Read and follow ~/executive-assistant-skills/skills/action-items-todoist/SKILL.md. Process ONLY the meeting titled '<meeting title>' that ended around <end time>. Send results to WhatsApp ({user.whatsapp})."
