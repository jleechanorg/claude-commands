...
- `~/.hermes/skills/finish-the-job/SKILL.md` v1.7.1 — Phase 0.5 disambiguation rule (fetch Slack thread to ground ambiguous task names BEFORE dispatching — see `references/finish-ambiguous-task-name-fetch-source-thread-2026-07-22.md`)
