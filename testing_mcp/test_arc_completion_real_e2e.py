...
def main():
    ...
    initial_arc_milestones = campaign_data.get("game_state", {}).get(
    ...
    arc_milestones_after = action3_data.get("game_state", {}).get(
        "custom_campaign_state", {}
    ).get("arc_milestones", {})
    ...
    final_arc_milestones = state_data.get("game_state", {}).get(
        "custom_campaign_state", {}
    ).get("arc_milestones", {})
