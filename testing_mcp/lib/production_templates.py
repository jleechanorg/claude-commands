"""Production campaign templates for testing real user flows.

These templates match actual production campaigns to ensure tests
validate the real user experience, not idealized test scenarios.
"""

# Full God Mode data from production campaign "My Epic Adventure"
# Campaign ID: lnlmmP15aZOSWhfr24Ou
# This template includes pre-defined character, world lore, and campaign setup
MY_EPIC_ADVENTURE_GOD_MODE = """Character: Ser Arion | Setting: World of Assiah. Caught between an oath to a ruthless tyrant who enforces a prosperous peace and the call of a chaotic dragon promising true freedom, a young knight must decide whether to slaughter innocents to preserve order or start a war to reclaim the world's soul. | Description: # Campaign summary
