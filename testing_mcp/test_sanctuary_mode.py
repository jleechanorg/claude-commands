...
def run_tests(server_url: str) -> tuple[list, list]:
    ...
    print("📋 Scenario 1: Complete mission to activate sanctuary...")
    ...
    print("📋 Scenario 2: Verify sanctuary prevents lethal events...")
    if sanctuary_active:
    ...
    print("📋 Scenario 3: Break sanctuary with major aggression...")
    if sanctuary_active:
    ...
    print("📋 Scenario 4: Verify sanctuary structure matches schema...")
    if sanctuary_mode:
