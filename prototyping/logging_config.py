...
class MetricsCollector:
    ...
    def record_validation(
        self, validator_name: str, duration: float, success: bool, narrative_length: int
    ):
        ...
        metrics["avg_duration"] = (
            metrics["total_duration"] / metrics["total_validations"]
        )
    ...
    def get_metrics(self, validator_name: str | None = None) -> dict[str, Any]:
    ...
    def reset(self, validator_name: str | None = None):
...
def log_validation_event(
    logger: logging.Logger, event_type: str, details: dict[str, Any]
):
...
class ValidationLogger:
    ...
    def __init__(self, test_name: str, logger: logging.Logger | None = None):
