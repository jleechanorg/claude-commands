...
def main():
            ...
            if user_input:
                ...
                if send_button:
                    ...
                    try:
                        ...
                        page.screenshot(path=f"{SCREENSHOT_DIR}/06_after_interaction.png")
                        print(f"✅ Screenshot: {SCREENSHOT_DIR}/06_after_interaction.png")
                    except:
    ...
    print(f"- Planning blocks: {'FOUND ✅' if len(planning_blocks) > 0 else 'NOT FOUND ❌'}")
...
def create_campaign(page):
    ...
    if prompt_input:
        prompt_input.fill("A test campaign to verify planning block buttons work. Start in a tavern.")
