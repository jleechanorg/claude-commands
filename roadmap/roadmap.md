...
*   Parallel
*   Further compression integrate alexiel book: `roadmap/alexiel_book_token_reduction_scratchpad.md`
*   Logging make it all tokens vs characters
*   Claude always getting directories wrong
*   Clicking on a campaign doesn’t show spinner loading and seems to not always register clicks

### Bugs
*   Null hp
*   Malformed JSON response
*   Dragon knight detailed v3 - random crypt introduced
*   Stable?
