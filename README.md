...
This export contains **168 commands** that transform Claude Code from a productivity tool into a **cognitive capital allocation platform**:
...
**Export Statistics**:
- **168 Commands**: Complete workflow orchestration system
