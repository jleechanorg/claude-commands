...
This export contains **195 commands** that transform Claude Code from a productivity tool into a **cognitive capital allocation platform**:
...
- **33 Skills**: Shared knowledge references (.claude/skills/)
...
- **43 Hooks**: Claude Code automation and workflow hooks
- **19 Scripts**: Development and automation tools (scripts/ directory)
- **28 Skills**: Shared knowledge references (.claude/skills/)
