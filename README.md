...
This export contains **180 commands** that transform Claude Code from a productivity tool into a **cognitive capital allocation platform**:
...
**Export Statistics**:
- **180 Commands**: Complete workflow orchestration system
