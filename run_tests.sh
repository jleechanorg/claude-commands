...
# Always include test_integration_mock.py from $PROJECT_ROOT/test_integration directory (fast mock tests)
if [ -f "./$PROJECT_ROOT/test_integration/test_integration_mock.py" ]; then
    test_files+=("./$PROJECT_ROOT/test_integration/test_integration_mock.py")
fi
