...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--help":
        ...
        print("")
        print(
            "This test validates structured fields campaign creation using Puppeteer MCP."
        )
        print(
            "Now uses shared utilities from testing_shared.py for test data and validation."
        )
    ...
    try:
        ...
        if success:
            ...
            print(
                "   Execute browser automation through Claude Code CLI with Puppeteer MCP"
            )
