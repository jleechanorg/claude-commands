        ...
        try:
            ...
            if page.is_visible("text=New Campaign"):
                ...
                if page.is_visible("#wizard-campaign-title"):
                    ...
                    page.fill("#wizard-campaign-prompt", "A fantasy realm filled with diverse characters and NPCs.")
            ...
            if not character_panel_found:
                print("   ⚠️  Character panel not found - looking for character creation options")
                
                # Look for character creation buttons
                if page.is_visible("text=Create Character") or page.is_visible("button:has-text('New Character')"):
            ...
            if not npc_panel_found:
                ...
                if page.is_visible("text=Create NPC") or page.is_visible("button:has-text('New NPC')"):
            ...
            if npc_panel_found:
                ...
                for selector in desc_selectors:
                    if page.is_visible(selector):
                        ...
                        page.fill(selector, "An ancient wizard who provides guidance to travelers.")
                        page.wait_for_timeout(500)
                        break
            ...
            if message_input:
                ...
                character_action = "I approach the Wise Sage and ask for advice about my quest."
            ...
            for selector in inventory_selectors:
                if page.is_visible(selector):
                    ...
                    if page.is_visible("button:has-text('Add Item')"):
                        ...
                        # Add a test item
                        item_name_field = page.query_selector("#item-name") or page.query_selector("input[placeholder*='item']")
                        if item_name_field:
