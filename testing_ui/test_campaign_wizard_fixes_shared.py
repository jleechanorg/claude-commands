...
def test_campaign_wizard_character_display_shared():
    ...
    with sync_playwright() as p:
        ...
        try:
            print("🧪 Testing campaign wizard character display fix (with shared utilities)...")
            ...
            print(f"✓ Filled form with shared test data: {campaign_data['character_name']}")
            ...
            validate_character_name_display(character_text, expected_character, "browser")
...
def test_campaign_wizard_empty_character_shared():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.fill("#wizard-campaign-title", campaign_data["title"])
            page.fill("#wizard-character-input", campaign_data["character_name"])  # Empty
            page.fill("#wizard-setting-input", campaign_data["setting"])
            ...
            assert "Auto-generated" in character_text or len(character_text.strip()) > 0, f"Expected auto-generated character but got: {character_text}"
            assert "Ser Arion" not in character_text, f"Found Dragon Knight default: {character_text}"
            print("✅ SUCCESS: Empty character handling working with shared validation!")
