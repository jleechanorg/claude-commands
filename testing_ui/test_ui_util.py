...
def setup_browser(headless: bool = DEFAULT_HEADLESS, viewport: Optional[Dict[str, int]] = None):
    """
...
def navigate_to_page(page: Page, path: str = "", port: int = DEFAULT_PORT, 
                    test_mode: bool = True, test_user_id: str = DEFAULT_TEST_USER,
...
def enable_request_logging(page: Page, filter_pattern: Optional[str] = None):
    """
...
def enable_response_logging(page: Page, filter_pattern: Optional[str] = None):
    """
...
def capture_api_request(page: Page, url_pattern: str, method: str = "POST") -> Dict[str, Any]:
    """
...
def fill_wizard_step1(page: Page, title: str, campaign_type: str = "custom",
                     character: Optional[str] = None, setting: Optional[str] = None):
    """
...
def run_ui_test(test_function: Callable, test_name: str, 
