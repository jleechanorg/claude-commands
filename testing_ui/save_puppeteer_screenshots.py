...
def save_screenshot_to_file(
    base64_data: str, name: str, output_dir: str = "/tmp/puppeteer_screenshots"
):
    """
...
def capture_and_save_screenshot(name: str, base64_data: str | None = None):
    """
    ...
    print(
        f"   Use: mcp__puppeteer-server__puppeteer_screenshot(name='{name}', encoded=True)"
    )
