    ...
    def run_test(self, page):
        ...
        try:
            ...
            campaign_infrastructure_exists = (
                page.is_visible("text=My Campaigns")
                or page.is_visible("text=Campaigns")
                or page.is_visible("text=New Campaign")
                or "campaign" in page.text_content("#dashboard-view").lower()
            )
            ...
            has_campaign_list = (
                page.is_visible("text=My Campaigns")
                or "campaigns" in page.text_content("#dashboard-view").lower()
            )
