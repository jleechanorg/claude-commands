...
class StructuredFieldsCampaignTest(BrowserTestBase):
    ...
    def run_test(self, page):
        ...
        try:
            ...
            if not helper.create_test_campaign("Structured Fields Test", debug_mode=True):
            ...
            if page.query_selector(".planning-block") or page.query_selector(".choice-button"):
            ...
            if page.query_selector(".dm-notes") or page.query_selector(".state-rationale"):
