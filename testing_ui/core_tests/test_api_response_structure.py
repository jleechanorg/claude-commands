    ...
    try:
        ...
        if god_response.status_code == 200:
            ...
            if "god_mode_response" in god_data:
                print(
                    f"✅ PASS: god_mode_response found: {god_data['god_mode_response'][:100]}..."
                )
            else:
            ...
            print(
                f"God mode request failed: {god_response.status_code} - {god_response.text}"
            )
