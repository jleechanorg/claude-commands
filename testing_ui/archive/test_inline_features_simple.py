    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if title_info.get("found"):
                ...
                print(
                    f"  Has inline-editable class: {title_info.get('hasInlineClass')}"
                )
                print(f"  Has click handler: {title_info.get('hasClickHandler')}")
                print(f"  Classes: {title_info.get('classNames')}")
                print(
                    f"  InlineEditor defined: {title_info.get('inlineEditorDefined')}"
                )
            ...
            print(
                f"StoryReader class defined: {controls_info.get('storyReaderDefined')}"
            )
