...
def take_screenshots():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.fill(
                "#campaign-prompt",
                "Test the new JSON planning block system with various scenarios.",
            )
            ...
            page.screenshot(
                path=os.path.join(screenshot_dir, "03_game_with_planning_block.png")
            )
            ...
            try:
                ...
                if choice_button:
                    ...
                    choice_button.hover()
                    page.screenshot(
                        path=os.path.join(screenshot_dir, "04_hovering_choice.png")
                    )
                    ...
                    page.screenshot(
                        path=os.path.join(screenshot_dir, "05_after_choice.png")
                    )
            ...
            if custom_input:
                custom_input.fill(
                    "I want to examine the room carefully for hidden doors"
                )
                page.screenshot(
                    path=os.path.join(screenshot_dir, "06_custom_action.png")
                )
