        ...
        if response.status_code == 201:
            ...
            if campaign_response.status_code == 200:
                ...
                if story:
                    ...
                    print("=" * 60)
                    print(narrative_text[:500] + "..." if len(narrative_text) > 500 else narrative_text)
                    print("=" * 60)
                    ...
                    with open("testing_ui/mock_data/dragon_knight_responses.json", "w") as f:
                    ...
                    if "Celestial Imperium" in narrative_text and "Empress Sariel" in narrative_text:
                        print("🎉 SUCCESS: Rich Dragon Knight narrative detected!")
                        return True
                    else:
                        print("⚠️  WARNING: Generic narrative returned instead of Dragon Knight content")
