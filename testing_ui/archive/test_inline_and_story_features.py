    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if campaigns:
                ...
                page.fill("#campaign-prompt", "A brave adventurer explores a mysterious dungeon filled with ancient treasures.")
                ...
                if edit_container:
                    ...
                    if edit_input:
                        ...
                        if save_btn:
                            ...
                            # Verify change
                            updated_title = page.query_selector("#game-title").inner_text()
                            if updated_title == new_name:
                                print(f"   ✅ Title successfully updated to: '{updated_title}'")
                            else:
                                print(f"   ❌ Title update failed. Current: '{updated_title}'")
                        else:
            ...
            if read_btn:
                ...
                if is_visible:
                    ...
                    if pause_visible:
                        print("    ✅ Pause button now visible - story reader activated!")
                        ...
                        sr_available = page.evaluate("() => typeof window.storyReader !== 'undefined'")
