...
def test_structured_fields_existing_campaign():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/1_campaign_loaded.png", full_page=True)
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/2_before_submit.png", full_page=True)
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/4_structured_fields_full.png", full_page=True)
            ...
            if debug_toggle:
                ...
                time.sleep(1)
                page.screenshot(path=f"{SCREENSHOT_DIR}/5_debug_mode.png", full_page=True)
