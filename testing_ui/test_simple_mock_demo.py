    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                dragon_knight_btn = page.query_selector("button[data-campaign-type='dragon_knight']")
                if dragon_knight_btn:
                    dragon_knight_btn.click()
                    print("✓ Selected Dragon Knight campaign type")
                
                # Take screenshot after form filled
                page.screenshot(path="/tmp/worldarchitectai/browser/mock_demo_02_filled.png")
                print("✓ Form filled screenshot saved")
                
                # Try to submit the form
                submit_btn = page.query_selector("button[type='submit'], .btn-primary, #create-campaign-btn")
                if submit_btn:
                    ...
                    page.screenshot(path="/tmp/worldarchitectai/browser/mock_demo_03_result.png")
                ...
                page.screenshot(path="/tmp/worldarchitectai/browser/mock_demo_error.png")
