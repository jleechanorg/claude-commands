...
def test_structured_fields():
    ...
    response = client.post(f'/api/campaigns/{campaign_id}/interaction',
        json={
    ...
    # Top level fields
    top_level_fields = ['response', 'dice_rolls', 'resources', 'planning_block', 
                       'session_header', 'debug_info', 'entities_mentioned', 
                       'location_confirmed', 'state_updates']
    ...
    resources_in_debug = 'debug_info' in data and 'resources' in data.get('debug_info', {})
