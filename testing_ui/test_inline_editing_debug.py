    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if campaign_cards:
                ...
                page.fill("#campaign-prompt", "A test campaign for debugging inline editing features.")
            ...
            inline_editor_exists = page.evaluate("() => typeof window.InlineEditor !== 'undefined'")
            print(f"   InlineEditor class exists: {inline_editor_exists}")
            
            # Check if StoryReader is available
            story_reader_exists = page.evaluate("() => typeof window.StoryReader !== 'undefined'")
