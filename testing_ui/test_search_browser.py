        ...
        try:
            ...
            if page.is_visible("text=New Campaign"):
                ...
                if page.is_visible("#wizard-campaign-title"):
                    ...
                    page.fill("#wizard-campaign-prompt", "A mystical forest with dragons, wizards, and ancient treasures.")
            ...
            for selector in search_selectors:
                if page.is_visible(selector):
                    ...
                    if selector.startswith("input"):
                        ...
                        if page.is_visible("text=dragon") or page.is_visible("text=fire"):
            ...
            if search_found:
                ...
                search_input = page.query_selector("#search-input") or page.query_selector("input[placeholder*='search']")
                ...
                for selector in history_selectors:
                    if page.is_visible(selector):
                        ...
                        if page.is_visible("text=dragon") or page.is_visible("text=wizard"):
