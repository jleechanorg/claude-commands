...
class MultiCampaignTest(BrowserTestBase):
    ...
    def run_test(self, page: Page) -> bool:
        ...
        try:
            ...
            for i, campaign_name in enumerate(campaign_names):
                ...
                if page.is_visible("text=New Campaign"):
                    ...
                    if page.is_visible("#wizard-campaign-title"):
                        ...
                        page.fill("#wizard-campaign-prompt", f"A {campaign_name.lower()} with unique storylines.")
                        ...
                        try:
                            ...
                            print(f"⚠️  {campaign_name} creation timeout - continuing anyway")
                        ...
                        if message_input:
                            ...
                            print(f"   📝 Established {campaign_name} with initial message")
            ...
            print(f"   📊 Found {campaign_found_count}/{len(created_campaigns)} campaigns")
            ...
            for i, campaign_name in enumerate(created_campaigns):
                if page.is_visible(f"text={campaign_name}"):
                    ...
                    try:
                        ...
                        message_input = page.query_selector("#message-input") or page.query_selector("textarea[placeholder*='What do you do']")
                        if message_input:
                            message_input.fill(f"I continue my adventure in {campaign_name}")
                            send_button = page.query_selector("button:has-text('Send')") or page.query_selector("#send-button")
                            if send_button:
                                send_button.click()
                            else:
                            ...
                            page.wait_for_timeout(3000)  # Wait for response
                            print(f"   📝 Confirmed campaign context for {campaign_name}")
