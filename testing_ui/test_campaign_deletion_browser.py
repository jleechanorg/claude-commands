        ...
        try:
            ...
            if page.is_visible("text=New Campaign"):
                ...
                if page.is_visible("#wizard-campaign-title"):
                    ...
                    page.fill("#wizard-campaign-prompt", "A temporary campaign that will be deleted.")
            ...
            if not campaign_found:
                print("⚠️  Campaign not found in dashboard - may have different UI structure")
            ...
            if delete_buttons:
                ...
                if page.is_visible("text=Are you sure") or page.is_visible("text=confirm") or page.is_visible("text=Delete"):
