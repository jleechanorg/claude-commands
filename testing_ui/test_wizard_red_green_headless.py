...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            test_url = f"{BASE_URL}/new-campaign?test_mode=true&test_user_id=red-green-demo"
            ...
            page.wait_for_selector('div.campaign-type-card[data-type="custom"]', state="visible", timeout=10000)
            ...
            if not page.locator("#wizard-custom-campaign").is_visible():
                page.wait_for_selector("#wizard-custom-campaign", state="visible", timeout=10000)
            page.wait_for_timeout(1000)
            ...
            print(f"   Options: '{options_text}' (should NOT contain 'Dragon Knight World')")
