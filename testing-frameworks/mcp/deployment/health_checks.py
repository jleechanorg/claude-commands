...
class HealthChecker:
    ...
    def check_http_service(self, url: str, path: str = "/health") -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "error": str(e), "url": full_url}
    ...
    def check_translation_layer(self, url: str) -> dict[str, Any]:
        ...
        for endpoint in test_endpoints:
            try:
                response = requests.get(urljoin(url, endpoint), timeout=self.timeout)
                endpoint_status[endpoint] = {
                    "status_code": response.status_code,
                    "accessible": True,
                }
            except Exception as e:
                endpoint_status[endpoint] = {"accessible": False, "error": str(e)}
    ...
    def check_redis(self, host: str, port: int = 6379) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "error": str(e), "service": "redis"}
