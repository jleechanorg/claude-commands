...
# Default Gemini model can be overridden via GEMINI_MODEL; prefer gemini-2.0-flash-exp by default
...
CLI_PROFILES = {
    ...
    "gemini": {
        ...
        # Stick to configured GEMINI_MODEL (default gemini-2.0-flash-exp) unless overridden
