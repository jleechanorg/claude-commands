...
# Default Gemini model can be overridden via GEMINI_MODEL; prefer gemini-1.5-pro by default
...
CLI_PROFILES = {
    ...
    "gemini": {
        ...
        # Stick to configured GEMINI_MODEL (default gemini-1.5-pro) unless overridden
