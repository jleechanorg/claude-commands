...
class ComplianceMemoryReader:
    ...
    def get_violation_patterns(self) -> dict[str, list[dict[str, Any]]]:
        ...
        violations = [
            ...
            if "compliance" in e["entityType"].lower()
            or "violation" in e["entityType"].lower()
        ]
...
class LearningMemoryReader:
    ...
    def get_learning_graph(self) -> dict[str, Any]:
        ...
        learning_entities = [
            e for e in graph["entities"] if "learning" in e["entityType"].lower()
        ]
        ...
        for relation in graph["relations"]:
            if relation["from"] in learning_names or relation["to"] in learning_names:
                learning_relations.append(relation)

        return {"entities": learning_entities, "relations": learning_relations}
...
def main():
    ...
    print(
        f"   Found {len(graph['entities'])} entities, {len(graph['relations'])} relations"
    )
