...
- ${PROJECT_DOMAIN:-your-project}.com (30 open PRs)
...
# Monitor real-time
tail -f ~/Library/Logs/${PROJECT_NAME:-your-project}-automation/jleechanorg_pr_monitor.log
```
...
```bash
# Service logs
cat ~/Library/Logs/${PROJECT_NAME:-your-project}-automation/jleechanorg-launchd.out
cat ~/Library/Logs/${PROJECT_NAME:-your-project}-automation/jleechanorg-launchd.err

# Application logs
tail -100 ~/Library/Logs/${PROJECT_NAME:-your-project}-automation/jleechanorg_pr_monitor.log
