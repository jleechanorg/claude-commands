    ...
    "tasks": [
        {
            ...
            "environment_id": None,
            "environment_label": "jleechanorg/your-project.com",
...
class TestRepoContextFallback(unittest.TestCase):
    ...
    def test_resolve_base_repo_uses_fixpr_clone_strategy(
        ...
        mock_ensure_base_clone.assert_called_once_with("jleechanorg/your-project.com")
    ...
    def test_find_existing_pr_branch_uses_repo_flag_without_git_cwd(self, _mock_resolve_repo_path, _mock_which, mock_run):
        ...
        result = api._find_existing_pr_branch(
            ...
            repo_full="jleechanorg/your-project.com",
        )

        self.assertIsNone(result)
        cmd = mock_run.call_args[0][0]
        self.assertIn("--repo", cmd)
        self.assertIn("jleechanorg/your-project.com", cmd)
    ...
    def test_find_existing_pr_by_task_id_uses_deterministic_branch_lookup(
            ...
            stdout=json.dumps([
                {
                    ...
                    "url": "https://github.com/jleechanorg/your-project.com/pull/5671",
                }
            ]),
            stderr="",
            returncode=0,
        ...
        self.assertEqual(
            result,
            ("codex/2eee21eb", "https://github.com/jleechanorg/your-project.com/pull/5671"),
        )
        cmd = mock_run.call_args[0][0]
