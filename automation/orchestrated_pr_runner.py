...
def dispatch_agent_for_pr(dispatcher: TaskDispatcher, pr: Dict, agent_cli: str | None = None) -> bool:
...
def run_fixpr_batch(cutoff_hours: int = DEFAULT_CUTOFF_HOURS, max_prs: int = DEFAULT_MAX_PRS, agent_cli: str | None = None) -> None:
