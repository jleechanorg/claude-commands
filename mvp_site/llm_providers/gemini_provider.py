...
def generate_content_with_code_execution(
    ...
    code_exec_override = (
        ...
        "modifier = 5\n"
        "total = roll + modifier\n"
        "print(f'DICE_RESULT: roll={roll}, modifier={modifier}, total={total}')\n"
        "```\n"
        "3. The DICE_RESULT output contains the ONLY valid dice value. Copy it EXACTLY.\n"
        "4. Populate `dice_audit_events` with: source=\"code_execution\", label, notation, rolls[], modifier, total.\n\n"
        ...
        "- Populating dice_rolls/dice_audit_events without corresponding code_execution output ← INVALID\n\n"
        "### Why This Matters:\n"
