/**
 * Campaign Descriptions for WorldArchitect.AI Frontend V2
 * Contains the full narrative content for different campaign types
 */

export const DRAGON_KNIGHT_DESCRIPTION = `# Campaign summary
...
// Short summary version for UI display
export const DRAGON_KNIGHT_SUMMARY = 'Embark on an epic journey as Ser Arion, a young knight torn between loyalty to the Empress and the call of freedom from a golden dragon.';

// Shortened version for API submission (under 5000 chars)
export const DRAGON_KNIGHT_DESCRIPTION_SHORT = `# Campaign: The Silent Throne

You are Ser Arion val Valerion, a 16-year-old knight sworn to protect the Celestial Imperium. The Empire is ruled by Empress Sariel, a ruthless tyrant who uses psychic power to maintain order. While her methods are terrifying, her reign has brought undeniable prosperity: roads are safe, trade flourishes, and the common people no longer starve. You are a product of this "Silent Peace."

Your loyalty is now brutally tested. You've been ordered to slaughter innocent refugees deemed a threat to the Empire's order. As you wrestle with this command, a powerful voice enters your mind—Aurum, the Gilded King, a magnificent gold dragon. He urges you to defy the Empress and fight for freedom.

You must choose: uphold your oath and commit an atrocity to preserve order, or break your vow and join the dragon's crusade for freedom. This choice will define your honor and path.

## The World of Assiah

The world was once ruled by the divine Seraphim who enforced perfect order through the subjugation of all "chaotic" races. After the mysterious Great Vanishing, their descendants, the Empyrean bloodline, inherited a fracturing world.

Centuries of ideological war between order and freedom culminated in the rise of Empress Sariel. Through psychic domination and political manipulation, she forged the Silent Throne and has ruled absolutely for decades. Her reign is one of terrifying efficiency—dissent is crushed before it forms, enemies vanish without trace, but the empire prospers.

Now, two dragons have awakened to challenge the Empress:
- **Aurum, the Gilded King** (Gold Dragon): Champions freedom and liberty, calling for crusade against tyranny
- **Umbrax, the Shadow of the Pit** (Black Dragon): Embodies nihilism and despair, seeking only to consume

The Silent Peace is ending. A war of ideas between the Tyrant, the Crusader, and the Nihilist begins.
...
**Starting Gear:**
- Valerion Plate: Fine heavy armor with your house sigil
- "Duty's Edge": Perfectly balanced longsword, a house heirloom
- The Gryphon Helm: Marks you as a knight of your order

**Starting Mission:** Your company, the "Argent Eaglets," has been ordered to pacify Lady Annalise Ashwood's keep. She harbors refugees in violation of Imperial law. Your commander, Prefect Gratian, expects absolute obedience. This is your first test as a knight.

**Key NPCs:**
- **Empress Sariel:** The psychic tyrant who maintains the Silent Peace
- **Aurum:** The gold dragon offering freedom at the cost of chaos
- **Prefect Gratian:** Your pragmatic commander who values order above all
- **Lady Annalise Ashwood:** The "traitor" who shelters refugees

The campaign begins in the frozen northern province of Winter-Mourn, where the roads are perfect Imperial stone but the moral choices are anything but clear.`;

// Maximum character length for campaign descriptions
export const MAX_DESCRIPTION_LENGTH = 100000;

// Default character name for Dragon Knight campaigns
export const DRAGON_KNIGHT_CHARACTER = 'Ser Arion val Valerion';