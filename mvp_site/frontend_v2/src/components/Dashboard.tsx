            ...
            <div className="min-h-[25vh] flex items-center justify-center">
              <div className="text-center space-y-8 max-w-2xl w-full">
                ...
                <Button
                  ...
                  className={`h-auto px-12 py-6 text-3xl bg-gradient-to-r ${colors.primary} hover:opacity-90 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-xl transform hover:scale-105`}
                >
