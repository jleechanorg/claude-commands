...
class TestGeminiErrorHandling(unittest.TestCase):
    ...
    def test_api_503_with_retry(self):
        ...
        with patch('gemini_service.genai.Client') as mock_client_class:
            ...
            self.assertEqual(calls[1][1]['model'], 'gemini-2.5-flash-lite-preview-06-17')
    ...
    def test_api_503_exhausted(self):
        ...
        with patch('gemini_service.genai.Client') as mock_client_class:
            ...
            self.assertEqual(mock_client.models.generate_content.call_count, expected_attempts)
    ...
    def test_connection_error_no_retry(self):
        ...
        with patch('gemini_service.genai.Client') as mock_client_class:
            ...
            mock_client.models.generate_content.side_effect = ValueError("Invalid request format")
