...
from gemini_service import _get_text_from_response, _process_structured_response
...
class TestGeminiResponseValidation(unittest.TestCase):
    ...
    def test_invalid_json_recovery(self):
        ...
        malformed_json = '{"narrative": "The story begins...", "entities_mentioned": ["hero"'
    ...
    def test_missing_role_field(self):
        ...
        self.assertIsInstance(structured, NarrativeResponse)
        self.assertEqual(structured.entities_mentioned, [])  # Should default to empty list
    ...
    def test_missing_parts_field(self):
        ...
        self.assertEqual(structured.location_confirmed, "Unknown")  # Should have default
    ...
    def test_null_values_handling(self):
        ...
        self.assertIsInstance(structured, NarrativeResponse)
        self.assertIsNotNone(structured.narrative)
        # Should use response_text as fallback for null narrative
        self.assertEqual(parsed_text, response_text)
    ...
    def test_oversized_response(self):
        ...
        oversized_response = {
            ...
            "state_updates": {f"key_{i}": f"value_{i}" for i in range(1000)}  # Large dict
        }
    ...
    def test_whitespace_only_content(self):
        ...
        whitespace_tests = [
            {"narrative": "   ", "entities_mentioned": ["ghost"], "location_confirmed": "Limbo"},
            {"narrative": "\n\n\n", "entities_mentioned": [], "location_confirmed": "Space"},
            {"narrative": "\t\t", "entities_mentioned": ["void"], "location_confirmed": "Tab Land"},
            {"narrative": " \n \t ", "entities_mentioned": [], "location_confirmed": "Mixed Space"}
        ]
        ...
        for test_case in whitespace_tests:
            ...
            self.assertEqual(structured.location_confirmed, test_case["location_confirmed"])
