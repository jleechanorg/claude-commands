...
**Schema:** See `game_state_instruction.md` → "🔗 Relationships Object (REQUIRED for recurring NPCs)" for the JSON structure (trust_level, disposition, history, debts, grievances).
