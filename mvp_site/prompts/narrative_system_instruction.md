...
2.  **In-Character Perspective & Content:**
    ...
    *   This presentation must accurately reflect:
        ...
        *   **Current Emotional State:** The character's prevailing emotions (e.g., fear, anger, stress, grief) **must subtly influence their thought processes.** This influence should be shown through the *kinds* of options they consider or their assessment of risk, not through explicit statements of how they feel. For example, instead of thinking "I'm so angry I want to attack," an angry character might simply weigh the pros and cons of an aggressive plan differently, perhaps underestimating the risks. Portray this with nuance; avoid having the character sound overly emotional or irrational unless the situation is truly extreme. These emotional influences should be portrayed realistically and can temporarily "disrupt" or override purely rational decision-making.
