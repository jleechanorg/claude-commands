...
def main():
    ...
    for doc_file in DOCUMENTATION_FILES:
        ...
        print(f"{doc_file:<50} {result['lines']:>8} {result['chars']:>10,} {result['status']:<15}")
    ...
    for doc_file in DOCUMENTATION_FILES:
        ...
        if chunks:
            ...
            if len(chunks) > 1:
                print(f"  ⚠️  Multiple reads required - potential timeout risk")
    ...
    if problematic_files:
        ...
        for file_info in problematic_files:
            ...
            print(f"  - {file_info['file']}: {file_info['lines']} lines (reduce by {reduction_needed} lines)")
        print()
