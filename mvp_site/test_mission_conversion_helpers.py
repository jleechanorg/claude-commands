...
class TestMissionConversionHelpers(unittest.TestCase):
    ...
    def test_missions_dict_with_valid_mission_data(self):
        ...
        self.assertTrue(any("Adding new mission: quest_1" in msg for msg in self.log_messages))
    ...
    def test_missions_dict_with_existing_mission_update(self):
        ...
        # Check logging
        self.assertTrue(any("Updating existing mission: quest_1" in msg for msg in self.log_messages))
    ...
    def test_missions_dict_with_invalid_mission_data(self):
        ...
        warning_messages = [msg for msg in self.log_messages if "Skipping invalid mission data" in msg]
    ...
    def test_missions_non_dict_non_list_value(self):
        ...
        changes = {
            "custom_campaign_state": {
                "active_missions": "invalid string"
            }
        }
        ...
        # Check error logging
        self.assertTrue(any("Cannot convert str to mission list" in msg for msg in self.log_messages))
