...
def update_state_with_changes_simplified(state_to_update: dict, changes: dict) -> dict:
    ...
    for key, value in changes.items():
        ...
        elif isinstance(value, dict) and isinstance(state_to_update.get(key), dict):
            state_to_update[key] = update_state_with_changes_simplified(state_to_update[key], value)
...
def test_delete_token_processing():
    ...
    assert updated_state["other_data"] == "should remain", "Other data should be unchanged"
    print("✅ Test 1 passed!")
