...
# =============================================================================
#
# Agent classes encapsulate the logic for different interaction modes.
# Each agent has a specific set of system prompts and processing behavior.
# This architecture allows for clean separation of concerns and focused prompt sets.
#
# Hierarchy:
