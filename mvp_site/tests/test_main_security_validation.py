...
class TestSQLInjectionPrevention(unittest.TestCase):
    ...
    def test_sql_injection_in_campaign_name(self):
        ...
        with patch('firestore_service.create_campaign') as mock_create:
            ...
            mock_create.assert_called_with("test_user", campaign_name, "Test description")
    ...
    def test_sql_injection_in_user_input(self):
        ...
        with patch('firestore_service.add_story_entry') as mock_add:
            ...
            mock_add.assert_called_once_with("test_user", "test_campaign", "player", malicious_text)
...
class TestXSSPrevention(unittest.TestCase):
    ...
    def test_xss_in_campaign_description(self):
        ...
        with patch('firestore_service.create_campaign') as mock_create:
            for script in self.malicious_scripts:
                ...
                result = mock_create("test_user", "Test Campaign", script, "Opening story", {})
    ...
    def test_script_tag_sanitization(self):
        ...
        with patch('firestore_service.add_story_entry') as mock_add:
            malicious_story = 'The wizard casts <script>steal_cookies()</script> a spell!'
    ...
    def test_event_handler_removal(self):
        ...
        with patch('firestore_service.add_story_entry') as mock_add:
            for dangerous_input in dangerous_inputs:
                ...
                result = mock_add("test_user", "test_campaign", "player", dangerous_input)
                self.assertTrue(result)
...
class TestRequestSizeLimits(unittest.TestCase):
    ...
    def test_request_body_size_limit(self):
        ...
        with patch('firestore_service.create_campaign') as mock_create:
            ...
            with self.assertRaises(ValueError) as context:
                mock_create("test_user", "Test Campaign", oversized_description, "Story", {})
    ...
    def test_array_size_limits(self):
        ...
        with patch('firestore_service.add_story_entry') as mock_add:
            ...
            result = mock_add("test_user", "test_campaign", "player", 
...
class TestRateLimitingEnforcement(unittest.TestCase):
    ...
    def test_rate_limit_by_endpoint(self):
        ...
        endpoint_counters = {endpoint: 0 for endpoint in endpoint_limits}
...
class TestInputSanitization(unittest.TestCase):
    ...
    def test_control_character_removal(self):
        ...
        for char in control_chars:
            ...
            sanitized = ''.join(c for c in test_string if c.isprintable() or c in '\n\r\t')
...
class TestCSRFProtection(unittest.TestCase):
    ...
    def test_csrf_token_validation(self):
        ...
        for method in state_changing_methods:
            with patch('firestore_service.create_campaign') as mock_create:
                ...
                result = mock_create("user", "campaign", "desc", "story", {}, 
    ...
    def test_origin_header_validation(self):
        ...
        for origin in valid_origins:
            ...
            is_valid = ('worldarchitect.ai' in origin.lower() or 
...
class TestPathTraversalAndPayloadAttacks(unittest.TestCase):
    ...
    def test_path_traversal_prevention(self):
        ...
        for dangerous_path in self.dangerous_paths:
            ...
            if dangerous_path.startswith('/'):
                ...
                has_traversal = '..' in dangerous_path or '%2e' in dangerous_path.lower()
                self.assertTrue(has_traversal, f"Path {dangerous_path} should contain traversal pattern")
            ...
            is_dangerous = (
                '..' in dangerous_path or 
                dangerous_path.startswith('/') or
                dangerous_path.startswith('C:') or
                '%2e' in dangerous_path.lower() or
                '\\' in dangerous_path
            )
            
            self.assertTrue(is_dangerous, f"Path {dangerous_path} should be recognized as dangerous")
    ...
    def test_json_bomb_protection(self):
        ...
        total_elements = sum(len(v) if isinstance(v, list) else 1 
                           for v in json_bomb.values() if isinstance(v, list))
    ...
    def test_xml_entity_expansion_prevention(self):
        ...
        self.assertTrue(has_entities and has_doctype, 
                       "Should detect potential XXE attack")
