...
class TestStateUpdateIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.skipTest("Integration tests require refactoring for current API - see state_updates validation in narrative_response_schema.py")
    ...
    def test_consecutive_state_updates(self):
        ...
        self.assertEqual(parsed_first['state_updates']['npc_data']['orc_warrior']['status'], "wounded")
        
        # Parse second response
        parsed_second = parse_structured_response(json.dumps(second_response))
        self.assertEqual(parsed_second['state_updates']['npc_data']['orc_warrior']['status'], "dead")
    ...
    def test_empty_state_updates_handling(self):
        ...
        for section in ['player_character_data', 'npc_data', 'world_data', 'custom_campaign_state']:
...
class TestStateUpdatePersistence(unittest.TestCase):
    ...
    def test_state_update_debug_logging(self):
        ...
        self.assertEqual(state_updates['player_character_data']['spell_slots_level_1'], "2")
