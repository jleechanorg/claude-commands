...
class TestNumericFieldConverter(unittest.TestCase):
    ...
    def test_convert_dict_with_fields(self):
        ...
        result = NumericFieldConverter.convert_dict_with_fields(test_dict, numeric_fields)
        ...
        self.assertEqual(result['description'], 'A ranger')  # Non-numeric field unchanged
    ...
    def test_invalid_data_handling(self):
        ...
        self.assertEqual(NumericFieldConverter.convert_dict_with_fields('not_a_dict', set()), 'not_a_dict')
