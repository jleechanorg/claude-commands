...
class TestNarrativeResponseErrorHandling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        pass  # No extractor class needed
    ...
    def test_god_mode_fallback_on_narrative_response_error(self):
        ...
        response_text = json.dumps({
            ...
            "invalid_field": {"nested": "data"},  # Extra field that might cause issues
            "state_updates": {
                "location": "tavern"
            }
        })
        ...
        with patch('narrative_response_schema.NarrativeResponse') as mock_nr:
            ...
            mock_nr.side_effect = [
                ...
                Mock(narrative="Combined response", god_mode_response="GM: The player enters the tavern.")
            ]
