...
class TestAnimationSystem(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.animation_css_path = os.path.join(parent_dir, 'static', 'styles', 'animations.css')
        self.animation_js_path = os.path.join(parent_dir, 'static', 'js', 'animation-helpers.js')
    ...
    def test_animation_css_exists_and_valid(self):
        ...
        self.assertTrue(os.path.exists(self.animation_css_path), 
                       "animations.css file should exist")
        
        with open(self.animation_css_path, 'r') as f:
            css_content = f.read()
        ...
        for animation in essential_animations:
            self.assertIn(animation, css_content, 
                         f"CSS should contain {animation}")
    ...
    def test_animation_js_exists_and_valid(self):
        ...
        self.assertTrue(os.path.exists(self.animation_js_path),
                       "animation-helpers.js file should exist")
        
        with open(self.animation_js_path, 'r') as f:
            js_content = f.read()
        ...
        for component in essential_components:
            self.assertIn(component, js_content,
                         f"JavaScript should contain {component}")
    ...
    def test_index_html_includes_animation_files(self):
        ...
        self.assertIn('href="/static/styles/animations.css"', html_content,
                     "Should include animations.css")
        self.assertIn('src="/static/js/animation-helpers.js"', html_content,
    ...
    def test_animation_css_syntax_validation(self):
        ...
        self.assertEqual(open_braces, close_braces, 
                        "CSS should have matching braces")
    ...
    def test_animation_performance_properties(self):
        ...
        for prop in performance_props:
            self.assertIn(prop, css_content,
                         f"Should include performance property {prop}")
    ...
    def test_theme_specific_animations(self):
        ...
        for feature in theme_features:
            self.assertIn(feature, css_content,
                         f"Should include theme feature {feature}")
    ...
    def test_accessibility_features(self):
        ...
        self.assertIn('animation-duration: 0.01ms', css_content,
...
class TestAnimationIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app_js_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'app.js')
    
    def test_animation_system_compatibility(self):
        """Test that animation system doesn't conflict with existing app.js"""
        # Check that both files exist
        animation_js_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'js', 'animation-helpers.js')
        
        self.assertTrue(os.path.exists(self.app_js_path),
                       "app.js should exist")
        self.assertTrue(os.path.exists(animation_js_path),
                       "animation-helpers.js should exist")
        
        # Read both files
        with open(self.app_js_path, 'r') as f:
            app_content = f.read()
        
        with open(animation_js_path, 'r') as f:
        ...
        if 'showView' in app_content:
            self.assertIn('originalShowView', animation_content,
    ...
    def test_loading_order_in_html(self):
        ...
        index_html_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'index.html')
        ...
        self.assertLess(theme_manager_pos, animation_helpers_pos,
                       "theme-manager.js should load before animation-helpers.js")
        self.assertLess(animation_helpers_pos, app_js_pos,
...
class TestAnimationPerformance(unittest.TestCase):
    ...
    def test_css_file_size(self):
        ...
        animation_css_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'styles', 'animations.css')
        
        if os.path.exists(animation_css_path):
            file_size = os.path.getsize(animation_css_path)
            # Should be under 50KB for performance
            self.assertLess(file_size, 50 * 1024,
    ...
    def test_javascript_file_size(self):
        ...
        if os.path.exists(animation_js_path):
            ...
            self.assertLess(file_size, 30 * 1024,
    ...
    def test_css_selector_efficiency(self):
        ...
        for pattern in inefficient_patterns:
            self.assertNotIn(pattern, css_content,
...
class TestAnimationFunctionality(unittest.TestCase):
    ...
    def test_animation_duration_variables(self):
        ...
        for var in duration_vars:
            self.assertIn(var, css_content,
                         f"Should define duration variable: {var}")
    ...
    def test_keyframe_animations_defined(self):
        ...
        for keyframe in keyframes:
            self.assertIn(keyframe, css_content,
                         f"Should define keyframe: {keyframe}")
    ...
    def test_javascript_api_methods(self):
        ...
        for method in api_methods:
            self.assertIn(method, js_content,
                         f"Should provide API method: {method}")
