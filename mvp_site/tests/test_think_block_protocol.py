...
class TestPromptFileIntegrity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        self.prompt_file = os.path.join(os.path.dirname(current_dir), 'prompts', 'narrative_system_instruction.md')
    ...
    def test_backup_file_exists(self):
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        backup_file = os.path.join(os.path.dirname(current_dir), 'prompts', 'narrative_system_instruction.md.backup')
