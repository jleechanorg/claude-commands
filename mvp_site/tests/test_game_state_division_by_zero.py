...
class TestGameStateDivisionByZero(unittest.TestCase):
    ...
    def test_validate_with_zero_hp_max_during_character_creation(self):
        ...
        narrative = "ApproveFoundation: Approve these choices and proceed to ability scores."
    ...
    def test_validate_detects_hp_narrative_mismatch(self):
        ...
        for discrepancy in discrepancies:
            if "unconscious" in discrepancy and "20/20" in discrepancy:
                ...
                break
        self.assertTrue(unconscious_discrepancy_found, f"Expected unconsciousness discrepancy not found in: {discrepancies}")
    ...
    def test_validate_character_creation_scenario(self):
        ...
        try:
            ...
            self.fail("validate_checkpoint_consistency raised ZeroDivisionError with hp_max=0")
