...
class TestGodModeJsonLoggingBug(unittest.TestCase):
    ...
    "debug_info": {}
        ...
        self.assertEqual(narrative_text, "Test god mode response with\nnewlines and special chars.")
    ...
    "debug_info": {}
        ...
        contains_json_structure = (
            '"narrative":' in logged_content or
            '"god_mode_response":' in logged_content or
            logged_content.startswith('{')
        )
        
        self.assertFalse(contains_json_structure, 
