...
from entity_validator import EntityValidator, EntityRetryManager, ValidationResult
...
class TestEntityRetryIntegration(unittest.TestCase):
    ...
    def test_validation_retry_flow_success(self):
        ...
        first_narrative = "Sariel enters the library where Valerius is studying ancient texts."
    ...
    def test_structured_response_validation_integration(self):
        ...
        expected_entities = ["Sariel", "Cassian", "Valerius"]
        coverage_result = validate_entity_coverage(structured_response, expected_entities)
    ...
    def test_location_aware_validation(self):
        ...
        self.assertTrue(any("Grand Library" in suggestion for suggestion in result.retry_suggestions))
