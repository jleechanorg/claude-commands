...
from entity_instructions import (
    ...
    entity_instruction_generator, entity_enforcement_checker
)
...
class TestEntityInstructionGenerator(unittest.TestCase):
    ...
    def test_build_instruction_templates(self):
        ...
        expected_categories = ['player_character', 'npc_referenced', 'location_npc', 'story_critical', 'background']
    ...
    def test_generate_entity_instructions_basic(self):
        ...
        result = self.generator.generate_entity_instructions(entities, player_references)
    ...
    def test_is_location_owner_valerius(self):
        ...
        self.assertFalse(self.generator._is_location_owner("Valerius", "Valerius's Study"))
        self.assertFalse(self.generator._is_location_owner("Valerius", "The Grand Study"))
    ...
    def test_is_location_owner_cressida(self):
        ...
        # Method now returns False for all (no hardcoding)
        self.assertFalse(self.generator._is_location_owner("Lady Cressida", "Lady Cressida's Chambers"))
        self.assertFalse(self.generator._is_location_owner("Cressida", "Private Chambers"))
    ...
    def test_create_cassian_specific_instruction_emotional(self):
        ...
        result = self.generator.create_entity_specific_instruction("Cassian",
            "Tell Cassian I was scared and helpless"
        )
...
class TestEntityEnforcementChecker(unittest.TestCase):
    ...
    def test_build_compliance_patterns(self):
        ...
        expected_categories = ['presence_indicators', 'action_indicators', 'dialogue_indicators']
        for category in expected_categories:
    ...
    def test_check_instruction_compliance_success(self):
        ...
        result = self.checker.check_instruction_compliance(narrative, mandatory_entities)
...
class TestEntityInstructionDataClass(unittest.TestCase):
    ...
    def test_entity_instruction_creation(self):
        ...
        self.assertEqual(instruction.entity_name, "Sariel")
        self.assertEqual(instruction.instruction_type, "mandatory")
        self.assertEqual(instruction.specific_instruction, "Player character must be present")
        self.assertEqual(instruction.priority, 1)
