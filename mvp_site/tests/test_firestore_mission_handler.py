...
class TestMissionHandler(unittest.TestCase):
    ...
    def test_process_mission_data_new_mission(self, mock_log):
        ...
        MissionHandler.process_mission_data(state, 'active_missions', 'quest1', mission_data)
    ...
    def test_handle_missions_dict_conversion(self, mock_warning):
        ...
        mock_warning.assert_called_once_with('Skipping invalid mission data for invalid: not a dictionary')
    ...
    def test_handle_active_missions_conversion_dict(self, mock_error, mock_warning):
        ...
        MissionHandler.handle_active_missions_conversion(state, 'active_missions', value)
    ...
    @patch('logging_util.warning')
    @patch('logging_util.error')
    def test_handle_active_missions_conversion_invalid_type(self, mock_error, mock_warning):
