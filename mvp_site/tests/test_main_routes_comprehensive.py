...
class TestBusinessLogic(unittest.TestCase):
    ...
    def test_prepare_game_state_success(self):
        ...
        with patch('main.firestore_service') as mock_firestore_service, \
            ...
            mock_firestore_service.get_campaign_game_state.assert_called_once_with('user123', 'campaign456')
    ...
    def test_prepare_game_state_firestore_error(self):
        ...
        with patch('main.firestore_service') as mock_firestore_service:
            ...
            mock_firestore_service.get_campaign_game_state.side_effect = Exception("Database error")
            ...
            mock_firestore_service.get_campaign_game_state.assert_called_once_with('test-user', 'test-campaign')
