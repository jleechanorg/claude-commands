...
class RealBrowserSettingsGameTest:
    ...
    def __init__(self):
        ...
        print(f"🌐 Real Browser Settings Game Integration Test")
    ...
    def make_game_request(self, campaign_id, user_input, expected_model):
        ...
        if response.status_code == 200:
            ...
            if model_found:
                ...
                print(f"⚠️ {expected_model} not clearly found in logs (but request succeeded)")
    ...
    def check_logs_for_model(self, expected_model, since_marker):
        ...
        try:
            ...
            print(f"   📝 Model indicators not found in recent logs")
            return False
