...
class TestSceneNumbering(unittest.TestCase):
    ...
    def test_user_scene_numbering(self):
        ...
        mock_story_entries = [
            {'actor': 'user', 'text': 'First user input', 'timestamp': datetime.datetime.now()},
            {'actor': 'gemini', 'text': 'First AI response', 'timestamp': datetime.datetime.now()},
            {'actor': 'user', 'text': 'Second user input', 'timestamp': datetime.datetime.now()},
            {'actor': 'gemini', 'text': 'Second AI response', 'timestamp': datetime.datetime.now()},
            {'actor': 'user', 'text': 'Third user input', 'timestamp': datetime.datetime.now()},
            {'actor': 'gemini', 'text': 'Third AI response', 'timestamp': datetime.datetime.now()},
        ]
