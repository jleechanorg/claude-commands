...
from world_loader import load_world_content_for_system_instruction, load_banned_names
...
class TestWorldLoaderE2E(unittest.TestCase):
    ...
    def test_world_content_loading_uses_cache(self):
        ...
        self.assertGreater(stats_after_first['cache_misses'], initial_stats['cache_misses'])
    ...
    def test_world_loader_cache_persistence_across_calls(self):
        ...
        world_content = load_world_content_for_system_instruction()  # Should load world + banned files
        banned_names = load_banned_names()    # Should use cached banned file
        world_content2 = load_world_content_for_system_instruction() # Should use all cached files
    ...
    def test_world_content_format_and_structure(self):
        ...
        final_stats = get_cache_stats()
        self.assertGreaterEqual(final_stats['cache_hits'], 2)  # At least 2 hits for content2 and content3
...
class TestWorldLoaderCacheIntegration(unittest.TestCase):
    ...
    def test_mixed_world_loader_calls_cache_efficiency(self):
        ...
        operations.append(load_world_content_for_system_instruction())      # Miss: world + banned files
        operations.append(load_banned_names())       # Hit: banned file already cached
        operations.append(load_world_content_for_system_instruction())      # Hit: both files already cached
        operations.append(load_banned_names())       # Hit: banned file already cached
        operations.append(load_world_content_for_system_instruction())      # Hit: both files already cached
