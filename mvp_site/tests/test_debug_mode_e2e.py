...
class TestDebugModeE2E(unittest.TestCase):
    ...
    def test_debug_content_always_in_ai_response(self):
        ...
        build_core_source = inspect.getsource(
            gemini_service.PromptBuilder.build_core_system_instructions
        )
    ...
    def test_full_e2e_debug_mode_disabled(self, mock_firestore_service):
        ...
        mock_gemini_response.get_narrative_text = MagicMock(
            side_effect=mock_get_narrative_text
        )
