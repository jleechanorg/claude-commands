...
class TestTimePressure(unittest.TestCase):
    ...
    def test_npc_agenda_progression(self):
        ...
        self.assertEqual(
            self.game_state.npc_agendas[npc_name]["progress_percentage"],
            30
        )
    ...
    def test_warning_generation(self):
        ...
        self.assertFalse(self.game_state.time_pressure_warnings[event_id]["subtle_given"])
    ...
    def test_world_resource_depletion(self):
        ...
        self.assertEqual(
            self.game_state.world_resources[resource_id]["current_amount"],
            100
        )
        self.assertEqual(
            self.game_state.world_resources[resource_id]["depletion_rate"],
            5
        )
