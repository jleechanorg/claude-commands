...
class TestBannedNamePreventionBehavior(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.master_directive_path = os.path.join(self.prompts_dir, "master_directive.md")
        self.mechanics_path = os.path.join(self.prompts_dir, "mechanics_system_instruction.md")
    ...
    def _contains_pre_generation_directive(self, content):
        ...
        has_pre_gen = "pre-generation" in content.lower() or "before generat" in content.lower()
    ...
    def test_master_directive_has_prevention_behavior(self):
        ...
        with open(self.master_directive_path, 'r', encoding='utf-8') as f:
            content = f.read()
        
        # Test behavior, not exact strings
        self.assertTrue(self._contains_pre_generation_directive(content),
                       "Master directive should contain pre-generation check behavior")
        self.assertTrue(self._contains_banned_name_examples(content),
                       "Should include examples of names to avoid")
        self.assertTrue(self._contains_scope_directive(content),
    ...
    def test_mechanics_instruction_has_prevention_behavior(self):
        ...
        with open(self.mechanics_path, 'r', encoding='utf-8') as f:
            content = f.read()
        ...
        self.assertTrue(has_critical and has_before and has_name_gen,
    ...
    def test_critical_reminders_include_naming(self):
        ...
        self.assertNotEqual(reminders_start, -1, "Should have critical reminders section")
        
        reminders_content = content[reminders_start:].lower()
        
        # Check for naming-related reminder
        has_naming_reminder = "nam" in reminders_content and ("restriction" in reminders_content or "check" in reminders_content)
        self.assertTrue(has_naming_reminder,
                       "Critical reminders should include naming checks")
