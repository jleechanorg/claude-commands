...
class TestConstants(unittest.TestCase):
    ...
    def test_prompt_filename_constants(self):
        ...
        self.assertEqual(
            constants.FILENAME_NARRATIVE, "narrative_system_instruction.md"
        )
        self.assertEqual(
            constants.FILENAME_MECHANICS, "mechanics_system_instruction.md"
        )
    ...
    def test_helper_functions(self):
        ...
        self.assertFalse(
            constants.uses_charisma("Unknown")
    ...
    def test_user_selectable_prompts(self):
        ...
        self.assertIn(
            constants.PROMPT_TYPE_NARRATIVE, constants.USER_SELECTABLE_PROMPTS
        )
        self.assertIn(
            constants.PROMPT_TYPE_MECHANICS, constants.USER_SELECTABLE_PROMPTS
        )
