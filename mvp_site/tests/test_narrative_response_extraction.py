...
class TestNarrativeResponseExtraction(unittest.TestCase):
    ...
    def test_narrative_response_initialization_all_fields(self):
        ...
        self.assertEqual(response.planning_block['thinking'], planning_block_json['thinking'])
        ...
        self.assertIn('Walk around', explore_choice['description'])  # Check substring to avoid HTML escaping issues
    ...
    def test_narrative_response_defaults(self):
        ...
        self.assertEqual(response.planning_block, {})  # Planning blocks are now JSON objects, empty by default
    ...
    def test_gemini_response_to_narrative_response_mapping(self):
        ...
        raw_response = json.dumps({
            ...
            "planning_block": {"thinking": "Mapped thinking", "choices": {"test": {"text": "Test"}}},
        ...
        self.assertEqual(narrative_response.planning_block['thinking'], "Mapped thinking")
