...
```'''
        ...
        # Partial/broken JSON
        self.partial_json = 'Some text before {"narrative": "The story continues", "entities_'
    ...
    def test_red_state_markdown_wrapped_json(self):
        ...
        self.assertNotIn("```json", narrative,
                        "BUG: Markdown formatting visible to user!")
        self.assertNotIn("```", narrative,
                        "BUG: Code block markers visible to user!")
        self.assertNotIn('"narrative":', narrative,
                        "BUG: JSON structure visible to user!")
    ...
    def test_red_state_partial_json_fallback(self):
        ...
        self.assertNotIn("Some text before", narrative,
                        "BUG: Non-narrative text visible!")
        self.assertNotIn('{"narrative":', narrative,
                        "BUG: JSON syntax visible!")
        self.assertNotIn('"entities_', narrative,
                        "BUG: Broken JSON visible!")
    ...
    def test_red_state_escaped_characters(self):
        ...
        self.assertNotIn('\\n', narrative,
                        "BUG: Escape sequences visible!")
        self.assertNotIn('\\"', narrative,
                        "BUG: Escaped quotes visible!")
