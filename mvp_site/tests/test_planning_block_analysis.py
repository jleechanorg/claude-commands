...
class TestPlanningBlockAnalysis(unittest.TestCase):
            ...
            "planning_block": {
                ...
                "choices": {
                    "attack_goblin": {
                        ...
                        "risk_level": "high",
                        "analysis": {
                            "pros": ["Quick resolution", "Shows courage", "Might intimidate others"],
                            "cons": ["Could get injured", "Might alert more enemies", "Uses resources"],
                            "confidence": "moderate"
                        }
                    },
                    "sneak_past": {
    ...
    def test_analysis_field_with_xss_attempts(self):
        ...
        self.assertEqual(analysis["pros"][0], "Safe option")  # Script tag completely removed
    ...
    def test_analysis_with_nested_structures(self):
        ...
        self.assertEqual(len(analysis["detailed_breakdown"]["combat_factors"]["advantages"]), 2)
