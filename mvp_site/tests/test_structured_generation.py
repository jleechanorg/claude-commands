...
=== END MANIFEST ==="""
    ...
    def test_structured_prompt_injection(self):
        ...
        injection = create_structured_prompt_injection(self.test_manifest, self.test_entities)
    ...
    def test_integration_with_entity_tracking(self):
        ...
        game_state = {
            ...
            'npc_data': {
                'NPC1': {'name': 'NPC1', 'hp': 50, 'hp_max': 50, 'present': True, 'conscious': True, 'hidden': False},
                'NPC2': {'name': 'NPC2', 'hp': 50, 'hp_max': 50, 'present': True, 'conscious': True, 'hidden': False}
            },
        ...
        prompt_injection = create_structured_prompt_injection(manifest_text, expected_entities)
