...
class TestNullNarrativeBugFix(unittest.TestCase):
    ...
    def test_null_narrative_field_no_raw_json(self):
        ...
        self.assertNotIn('"entities_mentioned"', narrative, "Raw JSON key should not appear")
    ...
    def test_missing_narrative_field_no_raw_json(self):
        ...
        self.assertEqual(narrative, "", "Missing narrative should result in empty string")
