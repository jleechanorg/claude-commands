...
from schemas.entities_simple import HealthStatus
...
class TestHPUnknownValues(unittest.TestCase):
    ...
    def test_hp_max_unknown_string(self):
        """Test HP_MAX='unknown' gets converted to 1"""
        health = HealthStatus(hp=5, hp_max='unknown')
        self.assertEqual(health.hp, 1)  # Gets clamped to hp_max
    ...
    def test_hp_max_none_value(self):
        """Test HP_MAX=None gets converted to 1"""
        health = HealthStatus(hp=5, hp_max=None)
        self.assertEqual(health.hp, 1)  # Gets clamped to hp_max
        self.assertEqual(health.hp_max, 1)
    ...
    def test_hp_exceeds_max_after_conversion(self):
        ...
        # HP=5 exceeds converted hp_max=1
        health = HealthStatus(hp=5, hp_max='unknown')
