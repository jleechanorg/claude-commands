...
class TestLukeCampaignGodModeJsonBug(unittest.TestCase):
    ...
    "debug_info": {
        ...
        narrative_text, structured_response = parse_structured_response(luke_campaign_raw_response)
        ...
        self.assertNotIn('"narrative":', narrative_text, "Processed narrative should not contain raw JSON keys")
        self.assertNotIn('"god_mode_response":', narrative_text, "Processed narrative should not contain raw JSON keys")
        self.assertNotIn('"entities_mentioned":', narrative_text, "Processed narrative should not contain raw JSON keys")
        self.assertNotIn('{', narrative_text, "Processed narrative should not contain JSON braces")
        self.assertNotIn('}', narrative_text, "Processed narrative should not contain JSON braces")
        
        # Test 2: Should contain the actual god mode response text
        expected_content = "That's another excellent point, and I understand why you'd expect EXP"
        self.assertIn(expected_content, narrative_text, "Should contain the actual god mode response text")
    ...
    "debug_info": {
        ...
        narrative_text, structured_response = parse_structured_response(luke_scene_56_response)
    ...
    "debug_info": {}
        ...
        narrative_text, structured_response = parse_structured_response(pattern_response)
    ...
    "debug_info": {"dm_notes": ["God mode test"]}
        ...
        self.assertEqual(gemini_response.state_updates, {"luke": {"alignment": "chaotic_evil"}})
