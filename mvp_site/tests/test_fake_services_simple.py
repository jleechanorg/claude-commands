...
from fake_gemini import FakeGeminiClient, create_fake_gemini_client
...
class TestFakeServicesSimple(unittest.TestCase):
    ...
    def test_fake_auth_user_management(self):
        ...
        new_user = auth.create_user(uid="new-user", email="new@test.com", display_name="New User")
    ...
    def test_fake_services_integration(self):
        ...
        campaign_doc = firestore.collection("campaigns").document("integration-campaign")
        campaign_data = {
