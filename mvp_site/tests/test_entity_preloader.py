...
from entity_preloader import EntityPreloader, LocationEntityEnforcer, entity_preloader, location_enforcer
...
class TestEntityPreloader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_game_state = {
            'session_data': {
                'player_characters': [
                    {'name': 'Sariel', 'hp_current': 25, 'hp_max': 30, 'status': 'normal'}
                ],
                'npcs': [
                    {'name': 'Cassian', 'hp_current': 20, 'hp_max': 20, 'status': 'normal', 'location': 'Throne Room'},
...
class TestLocationEntityEnforcer(unittest.TestCase):
    ...
    def test_get_required_entities_cressida_chambers(self):
        ...
        result = self.enforcer.get_required_entities_for_location("Lady Cressida's Chambers")
    ...
    def test_validate_location_entities_success(self):
        ...
        result = self.enforcer.validate_location_entities("Valerius's Study", present_entities)
    ...
    def test_generate_location_enforcement_text(self):
        ...
        result = self.enforcer.generate_location_enforcement_text("Lady Cressida's Chambers")
