...
📁 EVIDENCE STORAGE: All evidence saved to docs/v1_vs_v2_comparison/
"""
...
EVIDENCE_DIR = "docs/v1_vs_v2_comparison"
...
class EvidenceCollector:
    ...
    def capture_screenshot(self, page, test_id: str, step: str, description: str) -> str:
        """
    ...
    def capture_api_timing(self, test_id: str, api_call: str, start_time: float, end_time: float, response_data: Dict):
...
class BrowserTestHelper:
    ...
    def __init__(self, page, base_url: str, version: str, evidence_collector: EvidenceCollector):
        self.page = page
    ...
    def navigate_with_test_auth(self, test_id: str):
        ...
        self.evidence.capture_screenshot(self.page, test_id, "auth_init", f"{self.version.upper()} → Authentication Initialized")
    ...
    def create_dragon_knight_campaign(self, test_id: str) -> bool:
        ...
        try:
            ...
            self.evidence.document_error_state(test_id, "dragon_knight_creation_failed", {
                "error": str(e),
    ...
    def create_custom_lady_elara_campaign(self, test_id: str) -> bool:
        ...
        try:
            ...
            self.evidence.document_error_state(test_id, "custom_elara_creation_failed", {
                "error": str(e),
                "version": self.version,
    ...
    def create_full_custom_campaign(self, test_id: str) -> bool:
        ...
        try:
            ...
            self.evidence.document_error_state(test_id, "full_custom_creation_failed", {
                "error": str(e),
                "version": self.version
            })
            return False
    ...
    def test_planning_block_functionality(self, test_id: str) -> bool:
        ...
        try:
            ...
            planning_elements = self.page.query_selector_all('[class*="planning"], [id*="planning"]')
            
            self.evidence.capture_screenshot(self.page, test_id, "planning_block", "V2 → Planning Block Interface")
            ...
            self.evidence.document_error_state(test_id, "planning_block_test_failed", {
                "error": str(e)
            })
            return False
    ...
    def measure_api_performance(self, test_id: str, api_endpoint: str) -> Dict:
        ...
        try:
            ...
            response = requests.get(f"{self.base_url}{api_endpoint}", headers=headers)
            end_time = time.time()
            ...
            self.evidence.capture_api_timing(test_id, api_endpoint, start_time, end_time, response_data)
            ...
            self.evidence.capture_api_timing(test_id, api_endpoint, start_time, end_time, error_response)
    ...
    def _create_v1_dragon_knight(self, test_id: str) -> bool:
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v1_start", "V1 → Dashboard Initial State")
        
        # Navigate to campaign creation
        create_button = self.page.wait_for_selector("button:has-text('Create Campaign')")
        create_button.click()
        
        self.evidence.capture_screenshot(self.page, test_id, "v1_create_modal", "V1 → Create Campaign Modal")
        
        # Select Dragon Knight template
        dragon_knight_btn = self.page.wait_for_selector("button:has-text('Dragon Knight')")
        dragon_knight_btn.click()
        
        self.evidence.capture_screenshot(self.page, test_id, "v1_dragon_selected", "V1 → Dragon Knight Selected")
        
        # Complete creation
        start_adventure_btn = self.page.wait_for_selector("button:has-text('Start Adventure')")
        start_adventure_btn.click()
        
        # Wait for game view
        self.page.wait_for_selector("#game-container", timeout=10000)
        self.evidence.capture_screenshot(self.page, test_id, "v1_game_loaded", "V1 → Game View Loaded")
        
        return True
    
    def _create_v1_custom_elara(self, test_id: str) -> bool:
        """V1 Flask custom Lady Elara campaign"""
        self.evidence.capture_screenshot(self.page, test_id, "v1_custom_start", "V1 → Custom Campaign Start")
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v1_custom_form", "V1 → Custom Campaign Form")
        
        # Fill character name
        char_name_input = self.page.wait_for_selector("input[name='character_name']")
        char_name_input.fill("Lady Elara")
        
        self.evidence.capture_screenshot(self.page, test_id, "v1_elara_filled", "V1 → Lady Elara Character Name Filled")
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v1_elara_game", "V1 → Lady Elara in Game")
    ...
    def _create_v1_full_custom(self, test_id: str) -> bool:
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v1_full_custom", "V1 → Full Customization")
        return True
    ...
    def _create_v2_dragon_knight(self, test_id: str) -> bool:
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_start", "V2 → Dashboard Initial State")
        
        # Navigate through V2 React wizard
        create_btn = self.page.wait_for_selector("button:has-text('Create Your First Campaign')")
        create_btn.click()
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_wizard_step1", "V2 → Campaign Wizard Step 1")
        
        # Select Dragon Knight in step 1
        dragon_knight_option = self.page.wait_for_selector("input[value='dragon-knight']")
        dragon_knight_option.click()
        
        self.evidence.capture_screenshot(self.page, test_id, "v2_dragon_selected", "V2 → Dragon Knight Selected")
        
        # Navigate through wizard steps
        next_btn = self.page.wait_for_selector("button:has-text('Next')")
        next_btn.click()
        
        self.evidence.capture_screenshot(self.page, test_id, "v2_wizard_step2", "V2 → Campaign Wizard Step 2")
        
        next_btn = self.page.wait_for_selector("button:has-text('Next')")
        next_btn.click()
        
        self.evidence.capture_screenshot(self.page, test_id, "v2_wizard_step3", "V2 → Campaign Wizard Step 3")
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_game_loaded", "V2 → Game View Loaded")
        
        return True
    
    def _create_v2_custom_elara(self, test_id: str) -> bool:
        """V2 React custom Lady Elara campaign"""
        self.evidence.capture_screenshot(self.page, test_id, "v2_custom_start", "V2 → Custom Campaign Start")
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_custom_form", "V2 → Custom Campaign Form")
        
        # Fill character name in V2 form
        char_name_input = self.page.wait_for_selector("input[name='characterName']")
        char_name_input.fill("Lady Elara")
        
        self.evidence.capture_screenshot(self.page, test_id, "v2_elara_filled", "V2 → Lady Elara Character Name Filled")
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_elara_game", "V2 → Lady Elara in Game")
    ...
    def _create_v2_full_custom(self, test_id: str) -> bool:
        ...
        self.evidence.capture_screenshot(self.page, test_id, "v2_full_custom", "V2 → Full Customization")
        return True
...
class V1VsV2CampaignComparisonTest(unittest.TestCase):
    ...
    def _verify_server_availability(cls):
        ...
        for name, url in servers:
            try:
                ...
                raise unittest.SkipTest(f"{name} server not available for testing")
    ...
    def test_red_phase_dragon_knight_comparison(self):
        ...
        both_succeeded = self.test_results.get(v1_test_id, False) and self.test_results.get(v2_test_id, False)
        
        if both_succeeded:
            print("⚠️ Both systems succeeded - verify test methodology")
        else:
            print("✅ RED PHASE validated - at least one system showed expected failures")
    ...
    def test_green_phase_dragon_knight_comparison(self):
        ...
        for version in ["v1", "v2"]:
            ...
            try:
                ...
                print(f"✅ {version.upper()} Dragon Knight: {'SUCCESS' if success else 'FAILED'}")
        ...
        self.assertTrue(results.get("v1", False), "V1 Dragon Knight creation should succeed")
        self.assertTrue(results.get("v2", False), "V2 Dragon Knight creation should succeed") 
        
        print("✅ GREEN PHASE: Both systems successfully create Dragon Knight campaigns")
    ...
    def test_green_phase_custom_elara_comparison(self):
        ...
        for version in ["v1", "v2"]:
            ...
            try:
                ...
                api_performance = helper.measure_api_performance(test_id, "/api/campaigns")
                print(f"📊 {version.upper()} API Performance: {api_performance['response_time_ms']}ms")
        ...
        self.assertTrue(results.get("v1", False), "V1 should display 'Lady Elara' in game content")
        self.assertTrue(results.get("v2", False), "V2 should display 'Lady Elara' in game content")
    ...
    def test_v2_planning_block_functionality(self):
        ...
        self.assertTrue(planning_success, "V2 planning block functionality should be available")
    ...
    def test_api_performance_comparison(self):
        ...
        v1_campaigns_time = performance_results.get("v1_/api/campaigns", {}).get("response_time_ms", float('inf'))
        v2_campaigns_time = performance_results.get("v2_/api/campaigns", {}).get("response_time_ms", float('inf'))
        ...
        self.assertLess(v1_campaigns_time, 5000, "V1 API should respond within 5 seconds")
        self.assertLess(v2_campaigns_time, 5000, "V2 API should respond within 5 seconds")
    ...
    def tearDownClass(cls):
        ...
        coverage_percentage = (completed_tests / total_tests) * 100 if total_tests > 0 else 0
        ...
        report_file = f"{EVIDENCE_DIR}/comprehensive_test_report_{cls.evidence.test_run_id}.json"
        with open(report_file, 'w') as f:
            json.dump(report, f, indent=2, default=str)
        
        print(f"📋 Test Matrix Coverage: {coverage_percentage:.1f}% ({completed_tests}/{total_tests})")
