...
def test_numeric_race_selection():
    ...
    try:
        ...
        initial_response = get_initial_story(
            user_prompt, selected_prompts=selected_prompts
        )
        print("AI Response:")
        ...
        if "human" in class_response.lower() and (
            "class" in class_response.lower()
            or "fighter" in class_response.lower()
            or "wizard" in class_response.lower()
        ):
            print(
