...
class TestWorldLoaderIntegration(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if world_loader.WORLD_DIR.startswith(".."):
            world_loader.CELESTIAL_WARS_BOOK_PATH = os.path.join(
                world_loader.WORLD_DIR, "celestial_wars_alexiel_book.md"
            )
            world_loader.WORLD_ASSIAH_PATH = os.path.join(
                world_loader.WORLD_DIR, "world_assiah.md"
            )
    ...
    def test_path_construction_with_real_logic(self):
        ...
        # Create test files
        with open(
            os.path.join(parent_world, "celestial_wars_alexiel_book.md"), "w"
        ) as f:
        ...
        with patch.object(
            world_loader, "__file__", os.path.join(app_dir, "world_loader.py")
        ):
    ...
    def test_production_scenario_with_copied_files(self):
        ...
        with open(
            os.path.join(local_world, "celestial_wars_alexiel_book.md"), "w"
        ) as f:
    ...
    def test_error_path_in_logs(self):
        ...
        with patch.object(
            world_loader, "__file__", os.path.join(self.test_dir, "world_loader.py")
        ):
