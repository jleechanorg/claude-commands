...
class TestDebugModeCompliance(unittest.TestCase):
    ...
    def create_test_campaign(self, debug_mode=False):
        ...
        response = self.client.post(
            ...
            json={
                ...
                "selected_prompts": [
                    "narrative"
                ],  # No mechanics to avoid character creation
            },
        )
        ...
        if debug_mode:
            ...
            firestore_service.update_campaign_game_state(
                TEST_USER_ID, campaign_id, game_state.to_dict()
            )
    ...
    def make_interaction(self, campaign_id, user_input, mode="character"):
        ...
        if hasattr(self.test_setup, "set_timeout"):
            self.test_setup.set_timeout(
                60
            )  # 60 second timeout for debug compliance tests
    ...
    def test_debug_mode_on_compliance(self):
        ...
        result = self.make_interaction(
            campaign_id, "I approach the hooded figure cautiously."
        )
    ...
    def test_combat_interaction_debug_compliance(self):
        ...
        result = self.make_interaction(
            campaign_id, "I attack the hooded figure with my sword!"
        )
