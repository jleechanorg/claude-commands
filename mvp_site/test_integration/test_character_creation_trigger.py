...
class TestCharacterCreationTrigger(unittest.TestCase):
    ...
    def test_character_creation_with_mechanics_enabled(
        self, mock_get_client, mock_call_api
    ):
    ...
    @patch("gemini_service._call_gemini_api")
    @patch("gemini_service.get_client")
    def test_no_character_creation_without_mechanics(
        self, mock_get_client, mock_call_api
    ):
    ...
    @patch("gemini_service._call_gemini_api")
    @patch("gemini_service.get_client")
    def test_character_creation_with_mechanics_only(
        self, mock_get_client, mock_call_api
    ):
