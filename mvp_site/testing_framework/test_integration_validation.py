...
from testing_framework.integration_utils import (
    DualModeTestMixin, smart_patch, dual_mode_test,
    skip_in_real_mode, real_mode_only, validate_test_environment
)
...
class TestFrameworkIntegration(BaseTestCase):
    ...
    def test_firestore_operations(self):
        ...
        # Set data
        test_data = {'message': 'Hello from integration test', 'mode': 'real' if self.is_real else 'mock'}
    ...
    def test_gemini_operations(self):
        ...
        try:
            ...
            response = self.gemini.generate_content("Say 'Hello, World!' in a friendly way.")
            ...
            if self.is_real:
                ...
                assert hasattr(response, 'text') or hasattr(response, 'content'), "Response should have text content"
...
class TestBackwardsCompatibility(DualModeTestMixin, unittest.TestCase):
    ...
    def test_mock_compatibility_attributes(self):
        ...
        print(f"✅ Compatibility attributes available in {'REAL' if self.is_real_mode else 'MOCK'} mode")
...
class TestGradualMigration(unittest.TestCase):
    ...
    def test_gradual_adoption(self):
        ...
        if self.has_framework:
            ...
            print(f"✅ Gradual migration working with {'REAL' if self.services['is_real'] else 'MOCK'} services")
        else:
...
class TestResourceManagement(BaseTestCase):
    ...
    def test_isolation_between_tests(self):
        ...
        if hasattr(self, '_previous_test_id'):
            ...
            assert test_id != self._previous_test_id, "Should get fresh provider instance"
