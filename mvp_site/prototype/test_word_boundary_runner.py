#!/usr/bin/env python3
"""
Test runner for word boundary bug tests.
Must be run from project root to avoid import issues.
"""
...
class TestWordBoundaryBug(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.validator = token_validator.SimpleTokenValidator()
...
if __name__ == "__main__":
    ...
    # Create test suite
    suite = unittest.TestLoader().loadTestsFromTestCase(TestWordBoundaryBug)
