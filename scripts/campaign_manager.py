...
Examples:
  # Find user by email
  %(prog)s find-user jleechan@gmail.com
  
  # Query campaigns by name
  %(prog)s query vnLp2G3m21PJL6kxcuAqmWSOtm73 "My Epic Adventure"
  
  # Dry-run deletion
  %(prog)s delete vnLp2G3m21PJL6kxcuAqmWSOtm73 "My Epic Adventure"
  
  # Actual deletion with confirmation
  %(prog)s delete vnLp2G3m21PJL6kxcuAqmWSOtm73 "My Epic Adventure" --confirm
  
  # Force deletion without interactive prompt
  %(prog)s delete vnLp2G3m21PJL6kxcuAqmWSOtm73 "My Epic Adventure" --confirm --force
        """
    )
