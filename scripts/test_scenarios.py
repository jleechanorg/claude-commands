...
def create_npc_heavy_scenario() -> Dict[str, Any]:
    ...
    return {
        ...
        "can_summarize": ["Prince Roderick", "Court Wizard Merlin", "Lady Rosanne", 
                         "Duke Blackthorne", "Ambassador Chen"],  # Background NPCs
...
def get_all_scenarios() -> List[str]:
    ...
    return ["multi_character", "split_party", "combat_injured", 
