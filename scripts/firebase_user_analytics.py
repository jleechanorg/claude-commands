...
def analyze_user_campaigns(db, user_id):
    ...
    if user_data['total_campaigns'] > 0:
        user_data['avg_entries_per_campaign'] = user_data['total_entries'] / user_data['total_campaigns']
...
def generate_report(user_analytics):
    ...
    print("-" * 40)
    print(f"{'Rank':<4} {'User ID':<20} {'Campaigns':<10} {'Entries':<8} {'Avg/Campaign':<12} {'Most Active Campaign'}")
    print("-" * 80)
    ...
    for i, user in enumerate(sorted_users[:10], 1):
        ...
        print(f"{i:<4} {user['user_id']:<20} {user['total_campaigns']:<10} "
...
def main():
    ...
    try:
        ...
        print(f"   Processing first {len(limited_user_ids)} of {len(user_ids)} users for performance...")
        ...
        for i, user_id in enumerate(limited_user_ids, 1):
            ...
            if user_data['total_campaigns'] > 0:
                print(f"     ✅ {user_data['total_campaigns']} campaigns, {user_data['total_entries']} entries")
