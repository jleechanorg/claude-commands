...
install_mcp_mail() {
    ...
    log_with_timestamp "Setting up MCP server: mcp_mail (HTTP: http://127.0.0.1:8765/mcp/)"

    # Check if server already exists
    if server_already_exists "mcp_mail"; then
        echo -e "${GREEN}  ✅ Server mcp_mail already exists, skipping installation${NC}"
