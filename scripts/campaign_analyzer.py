...
class DesyncPattern:
    ...
    def __init__(self, session: int, turn: int, pattern_type: str, 
                 expected: List[str], found: List[str], missing: List[str],
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "narrative_excerpt": self.narrative_excerpt[:200] + "..." if len(self.narrative_excerpt) > 200 else self.narrative_excerpt,
...
class CampaignAnalyzer:
    ...
    def _classify_desync_pattern(self, game_state: Dict[str, Any], 
    ...
    def export_campaign_snapshot(self, campaign_data: Dict[str, Any], 
                               output_path: str):
                ...
                "turns": [
                    ...
                    },
                    {
                        ...
                        "game_state": {
                            ...
                            "combat_state": {"in_combat": True, "participants": ["Sariel", "Cassian", "Guard"]}
                        },
