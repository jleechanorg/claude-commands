...
def example_firestore_bug_fix():
    ...
    response = PRCommentFormatter.create_response("Firestore Bug Fix & Comment Resolution")
    ...
    response.final_status = "All comments addressed, tests passing (94/94), ready for review"
...
def example_performance_optimization():
    ...
    response = PRCommentFormatter.create_response("Performance Optimization Implementation")
    ...
    response.final_status = "Performance improved by 60%, all optimization goals achieved"
...
def main():
    ...
    print("2. Use the JSON files with: ./claude_command_scripts/pr-comment-format.sh json <filename>")
