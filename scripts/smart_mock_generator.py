...
class SmartMockGenerator:
    ...
    def generate_api_mock(self, endpoints: Optional[Dict[str, Any]] = None) -> Mock:
    ...
    def generate_database_mock(self, schema: Optional[Dict[str, List[str]]] = None) -> Mock:
    ...
    def generate_all_mocks(self, 
                          ...
                          db_schema: Optional[Dict[str, List[str]]] = None) -> Dict[str, Mock]:
        mocks = {}
