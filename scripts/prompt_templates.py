...
class PromptTemplates:
    ...
    def get_baseline_prompt(game_state: Dict[str, Any], context: str = "") -> str:
        ...
        pc_name = game_state.get("player_character_data", {}).get("name", "the character")
...
<narrative>
    ...
    @staticmethod
    def get_chain_of_thought_prompt(game_state: Dict[str, Any], 
...
def get_prompt_for_approach(approach: str, game_state: Dict[str, Any], 
                           manifest: SceneManifest = None,
                           expected_entities: List[str] = None) -> str:
