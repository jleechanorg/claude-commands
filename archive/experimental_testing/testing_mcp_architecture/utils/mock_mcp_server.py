...
class MockMCPServer:
    ...
    def _handle_tool_call(
        ...
        if not handler:
            return self._error_response(
                -32601, f"Tool not found: {tool_name}", request_id
            )
        ...
        try:
            ...
            if isinstance(result, dict) and result.get("status") == "error":
                ...
                return self._error_response(
                    -32000, f"{error_type}: {error_msg}", request_id
                )
    ...
    def _error_response(
        self, code: int, message: str, request_id: int
    ) -> dict[str, Any]:
    ...
    def _get_campaigns(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"status": "success", "data": {"campaigns": user_campaigns}}
    ...
    def _get_campaign(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"status": "success", "data": asdict(campaign)}
    ...
    def _create_character(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"status": "success", "data": asdict(character)}
    ...
    def _get_user_settings(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"status": "success", "data": asdict(settings)}
