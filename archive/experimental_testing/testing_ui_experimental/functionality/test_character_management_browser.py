...
class CharacterManagementTest(BrowserTestBase):
    ...
    def _create_test_campaign(self, page: Page) -> bool:
        ...
        if page.is_visible("#wizard-campaign-title"):
            ...
            page.fill(
                ...
                "A D&D campaign for testing character management features.",
            )
            ...
            for _i in range(4):
                if page.is_visible("#wizard-next"):
                    ...
                    launch_btn = page.query_selector(
                        "#launch-campaign"
                    ) or page.query_selector("button:has-text('Begin Adventure')")
                    if launch_btn:
                        launch_btn.click()
                    break
    ...
    def _access_character_sheet(self, page: Page) -> bool:
        ...
        try:
            ...
            page.wait_for_timeout(1000)
            if page.is_visible(".character-sheet") or page.is_visible(
                "#character-sheet"
            ):
